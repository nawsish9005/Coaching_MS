...
function addCounter()
{
    ...
    {
        counter = parseInt(document.getElementById('database_row').value);
        name_counter = parseInt(document.getElementById('database_row').value);
    }
    counter = parseInt(parseInt(counter) + 1);
    name_counter = parseInt(parseInt(name_counter) + 1);
