<?php 
	...
	$sql_for_row_data = " SELECT id FROM process_name_define_after_greige_receiving WHERE 	greige_issunce_id = '$greige_issunce_id' ";
	...
	for ($i = 1; $i <= $row_for_row_data; $i++)
 	{
 		...
 		if($_POST['route'.$i])
 		{
			...
			$insert_sql_statement = "UPDATE `process_name_define_after_greige_receiving` 
						    SET `active`= '0',
