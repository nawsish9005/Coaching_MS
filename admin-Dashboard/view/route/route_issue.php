...
<body class="nav-md">
              ...
              <div class="">
                <div class="page-title">
                  <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>PP Wise Process QC Result</li>
                        <li>Add or Edit Process Route Result</li>
                    </ol>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Add / Edit Process Route Result </h2>
    ...
    <script type="text/javascript">
      ...
      function editroute(serial)
      {
        ...
        var greige_issunce_id_for_edit = document.getElementsByClassName("greige_issunce_id_for_"+serial)[0].value;
        //var greige_issunce_id_for_view = serial; 
        var pp_no_id_for_edit = document.getElementById("pp_no_id_for_edit").value;
        var pp_details_id_for_edit = document.getElementById("pp_details_id_for_edit").value;
        var route_issue_id_for_edit = document.getElementsByClassName("route_issue_id_for_"+serial)[0].value;
        ...
        $.ajax(
        {
            ...
            data: 
            {
              pp_no_id_for_edit: pp_no_id_for_edit, 
              pp_details_id_for_edit: pp_details_id_for_edit,
              greige_issunce_id_for_edit: greige_issunce_id_for_edit,
              route_issue_id_for_edit: route_issue_id_for_edit
            },
      ...
      {
        var greige_issunce_id_for_view = document.getElementsByClassName("greige_issunce_id_for_"+serial)[0].value;
        //var greige_issunce_id_for_view = serial; 
        var pp_no_id_for_view = document.getElementById("pp_no_id_for_view").value;
        var pp_details_id_for_view = document.getElementById("pp_details_id_for_view").value;
        var route_issue_id_for_view = document.getElementsByClassName("route_issue_id_for_"+serial)[0].value;
        ...
        $.ajax(
        {
            ...
            data: 
            {
              pp_no_id_for_view: pp_no_id_for_view, 
              pp_details_id_for_view: pp_details_id_for_view,
              greige_issunce_id_for_view: greige_issunce_id_for_view,
              route_issue_id_for_view: route_issue_id_for_view
            },
            success:function(data)
            {
                $('#retrieve_route_data').html(data);
