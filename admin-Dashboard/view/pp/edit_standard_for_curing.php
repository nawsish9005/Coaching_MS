...
$sql_for_curing_standard = "SELECT * FROM curing_standard WHERE pp_no_id = '$pp_no_id' AND pp_details_id = '$pp_details_id' AND active = '1' ";
...
<div class="x_panel">
  <div class="x_title">
    <h2>Curing/Streaming Standards Edit Form</h2>
    ...
    <form id="curing_standard_form" name="curing_standard_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-1 col-sm-1 col-xs-2">
          <select id="rubbing_cond1" name="rubbing_cond1" onchange="rubbing_condition()" class="rubbing_cond1 form-control col-md-12 col-xs-12">
            ...
            <option <?php if($row_for_curing_standard['rubbing_cond1'] == 1) {echo "selected";} ?> value="1">(</option>
            <option <?php if($row_for_curing_standard['rubbing_cond1'] == 2) {echo "selected";} ?>  value="2">[</option>
          </select>
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2">
          <input type="text" id="rubbing_value1" value="<?php echo $row_for_curing_standard['rubbing_value1']; ?>" name="rubbing_value1" class="rubbing_value1 form-control col-md-7 col-xs-12">
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
          --
        </div> 
        <div class="col-md-1 col-sm-1 col-xs-2">
          <input type="text" id="rubbing_value2" value="<?php echo $row_for_curing_standard['rubbing_value2']; ?>" name="rubbing_value2" class="rubbing_value2 form-control col-md-7 col-xs-12">
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2">
          <select id="rubbing_cond2" name="rubbing_cond2" class="rubbing_cond2 form-control col-md-12 col-xs-12">
            <option value="">Select Condition</option>
            <option <?php if($row_for_curing_standard['rubbing_cond2'] == 1) {echo "selected";} ?> value="1">)</option>
            <option <?php if($row_for_curing_standard['rubbing_cond2'] == 2) {echo "selected";} ?> value="2">]</option>
          </select>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <button type="button" name="submit" id="submit" onclick="update_edit_curing_standard_data('<?php echo $pp_details_id; ?>');" class="btn btn-success" >Update</button>
