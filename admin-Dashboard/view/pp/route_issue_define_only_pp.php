                ...
                <div class="page-title">
                  <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>Define PP All Version Standard</li>
                    </ol>
                  </div>
                </div>
                        ...
                        <form id="define-standard-form" action="" method="" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <!-- <div class="form-group" style="padding-left: 7px;">
                            <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-2">
                              <button type="button" disabled class="btn btn-success">Submit</button>
                            </div>
                          </div> -->
                        </form>
                      </div>
...
<script type="text/javascript">
  ...
  function on_submit_for_route_issue_data()
  {
      ...
      {
        type: "POST",
        url: "route_selection_for_pp_saving.php",
        data: formdata,
        processData: false,
        contentType: false,
        ...
        success: function(data) 
        {
            ...
            $.ajax(
            {
                url: "route_issue_process_pp.php",
                method: "POST",
                data: {pp_no_id: pp_no_id},
                success:function(data)
                {
 ...
 $(document).ready(function() 
 {
  ...
  function view_standard_select_pp(serial)
  {
      var pp_no_id = document.getElementById("pp_no_id_"+serial).value;
