          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp = "SELECT 
                                ...
                                pp_details.quantity,
                                ready_mercerize_standard.*

                             FROM 
                                pp, pp_details, ready_mercerize_standard   
                             WHERE 
                                pp.pp_id = '$pp_no_id'
                                AND pp.pp_id = pp_details.pp_no_id
                                AND pp_details.pp_id = '$pp_version'
                                AND ready_mercerize_standard.pp_no_id = pp_details.pp_no_id
                                AND ready_mercerize_standard.pp_details_id = pp_details.pp_id
                                AND ready_mercerize_standard.active = '1'
            ...
            <tr>
              ...
              <td>
                <!-- <form action="gray_varibale_edit.php" method="post" style="display: inline-block;"> -->
                  ...
                  <button type="submit" id="ready_mercerize_standard_add_btn" name="ready_mercerize_standard_add_btn" onclick="edit_for_ready_mercerize_standard();" class="btn btn-primary btn-xs"> Edit </button>
                <!-- </form> --> 
              </td>
            </tr>
            <?php 
