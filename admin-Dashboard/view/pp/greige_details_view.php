                       ...
                       <!--  <div>
                          <form action="" method="post" style="display: inline;">
                            ...
                            <input type="hidden" id="pp_no_id_for_view" name="pp_no_id_for_view" value="<?php echo $pp_no_id; ?>">
                             <input type="hidden" id="route_issue_id_for_view" name="route_issue_id_for_view" value="<?php echo $route_issue_id; ?>">
                            <input type="hidden" id="pp_details_id_for_view" name="pp_details_id_for_view" value="<?php echo $pp_details_id; ?>">
