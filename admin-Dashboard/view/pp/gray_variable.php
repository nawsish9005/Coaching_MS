                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <select id="pp_version_standard" name="pp_version_standard" class="pp_version_standard select2 pp_number form-control col-md-12 col-xs-12">
                                ...
                                <option value="8" >Curing/Steaming</option>
                              </select> 
                            </div>
                          </div>
...
<script type="text/javascript">
  ...
  //for printing
  function rubbing_tol_cal_1()
  {
      // var rubbing_tol_value1 = parseFloat(document.getElementById("rubbing_tol_value1").value);
      // var rubbing_tol_value2 = parseFloat(document.getElementById("rubbing_tol_value2").value);

      // if(isNaN(document.getElementById("rubbing_tol_value1").value))
      // {
      //     number_alert("rubbing_tol_value1");
      //     return false;
      // }

      // if(isNaN(document.getElementById("rubbing_tol_value2").value))
      // {
      //     number_alert("rubbing_tol_value2");
      //     return false;
      // }

      // document.getElementById("rubbing_cond1").value = 1;
      // document.getElementById("rubbing_cond2").value = 1;

      // var tolarance = (rubbing_tol_value2 / 100);
      // var rubbing_tol_cal_value2 = rubbing_tol_value1 + tolarance;
      // var rubbing_tol_cal_value1 = rubbing_tol_value1 - tolarance;

      // document.getElementById("rubbing_value1").value = rubbing_tol_cal_value1.toFixed(5);
      // document.getElementById("rubbing_value2").value = rubbing_tol_cal_value2.toFixed(5);

      var rubbing_tol_value1 = parseFloat(document.getElementById("rubbing_tol_value1").value);
      var rubbing_tol_value2 = parseFloat(document.getElementById("rubbing_tol_value2").value);
      var rubbing_tol_cond = document.getElementById("rubbing_tol_cond").value;

      if (rubbing_tol_cond == 1) 
      {
          document.getElementById("rubbing_cond1").value = 2;
          document.getElementById("rubbing_cond2").value = 2;

          var tolarance = ((rubbing_tol_value2 * rubbing_tol_value1) / 100);
          var rubbing_tol_cal_value2 = rubbing_tol_value1 + tolarance;
          var rubbing_tol_cal_value1 = rubbing_tol_value1 - tolarance;
      ...
      if (rubbing_tol_cond == 2)
      {
          ...
          document.getElementById("rubbing_value1").value = rubbing_tol_value1;
          document.getElementById("rubbing_value2").value = rubbing_tol_cal_value2.toFixed(5);
      }

      if (rubbing_tol_cond == 3)
      {
          document.getElementById("rubbing_cond1").value = 2;
          document.getElementById("rubbing_cond2").value = 2;
          ...
          document.getElementById("rubbing_value2").value = rubbing_tol_value1;
          document.getElementById("rubbing_value1").value = rubbing_tol_cal_value2.toFixed(5);
      }
  ...
  function rubbing_tol_condition()
  {
      var rubbing_tol_value1 = parseFloat(document.getElementById("rubbing_tol_value1").value);
      var rubbing_tol_value2 = parseFloat(document.getElementById("rubbing_tol_value2").value);
      var rubbing_tol_cond = document.getElementById("rubbing_tol_cond").value;
