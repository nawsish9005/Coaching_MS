             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        ...
                        $res_for_pp_details = mysqli_query($con, $sql_for_pp_details);
                          ...
                          while ($row_details_for_pp = mysqli_fetch_assoc($res_for_pp_details)) 
                          {
                            ...
                            <tr>
                              ...
                              <!-- <td><?php echo $row_details_for_pp['fiber_warp'] ?></td>
                              <td><?php echo $row_details_for_pp['fiber_weft'] ?></td> -->
                    ...
                    <h2>Total Received Quantity = <?php echo $total_received_quantity; ?> </h2>
                  </div>
                </div>
              </div>
          </div>
