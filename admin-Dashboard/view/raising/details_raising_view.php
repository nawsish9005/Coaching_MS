...
if ($route_issue_id == "" || is_null($route_issue_id) || empty($route_issue_id) || 
    $raising_id == "" || is_null($raising_id) || empty($raising_id)) 
{
    echo "No data found";
}
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form action="edit_raising.php" method="post" style="display: inline; padding-left: 200px;">
                          <input type="hidden" id="route_issue_id" name="route_issue_id" value="<?php echo $route_issue_id; ?>">
        				          <input type="hidden" id="raising_id" name="raising_id" value="<?php echo $raising_id; ?>">
