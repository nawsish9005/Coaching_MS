                      ...
                      <div class="x_content">
                        ...
                        <?php
                          $sql_for_bleaching = "SELECT *
                                         ...
                                         AND raising_id = '$raising_id'
                                        ";
                          $res_for_bleaching = mysqli_query($con, $sql_for_bleaching);
                          $row_bleaching = mysqli_fetch_assoc($res_for_bleaching);
                        ?>
                        <form id="raising_form" name="raising_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="raising_quality">Face/Back <span class="required">*</span>
                            </label>
                            <div readonly class="col-md-6 col-sm-6 col-xs-12">
                              <p>
                                 OK :
                                <input disabled type="radio" class="flat" name="raising_quality" id="ok" value="1" <?php if($row_bleaching['raising_quality'] == '1') echo 'checked'; ?> />
                                 Not OK :
                                <input disabled type="radio" class="flat" name="raising_quality" id="notok" value="0" <?php if($row_bleaching['raising_quality'] == '0') echo 'checked'; ?> />
                              </p>
                            </div>
                          </div>
                          <br>   
     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              formdata.append("raising_id", <?php echo $raising_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_raising_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_raising.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
