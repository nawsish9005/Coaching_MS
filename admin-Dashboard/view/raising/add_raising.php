        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main" style="margin-bottom: 10px;">
              <div class="">
                ...
                <?php 
                    $sql_for_raising_standard = "SELECT *
                    ...
                    $row_for_raising_standard = mysqli_fetch_array($res_for_raising_standard);
                ?>
                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form id="raising_form" name="raising_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="raising_quality">Raising Quality <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <p>
                                 OK :
                                <input type="radio" class="flat" name="raising_quality" id="ok" value="1" checked/>
                                 Not OK :
                                <input type="radio" class="flat" name="raising_quality" id="notok" value="0" />
                              </p>
                            </div>
                          </div>
                          <br>
    ...
    <script type="text/javascript">
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          {
              var formdata = new FormData(document.getElementById('raising_form'));
              formdata.append("route_issue_id", <?php echo $route_issue_id; ?> );
              $.ajax({
              type: "POST",
              url: "add_raising_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
