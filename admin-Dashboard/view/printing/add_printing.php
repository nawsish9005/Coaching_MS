     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              $.ajax({
              type: "POST",
              url: "add_printing_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_printing.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
