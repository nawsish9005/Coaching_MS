                          ...
                          <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php
                                ...
                                {
                                    $printing_id = $row_pp_details['printing_id'];
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                        <input type="hidden" id="route_issue_id<?php echo $printing_id; ?>" name="route_issue_id<?php echo $printing_id; ?>" value="<?php echo $route_issue_id; ?>">
                                        <input type="hidden" id="greige_issunce_id<?php echo $printing_id; ?>" name="greige_issunce_id<?php echo $printing_id; ?>" value="<?php echo $greige_issunce_id; ?>">
                                        <input type="hidden" id="pp_no_id<?php echo $printing_id; ?>" name="pp_no_id<?php echo $printing_id; ?>" value="<?php echo $pp_no_id; ?>">
                                        <input type="hidden" id="pp_details_id<?php echo $printing_id; ?>" name="pp_details_id<?php echo $printing_id; ?>" value="<?php echo $pp_details_id; ?>">
                                        <button type="button" id="gray_issue_add_btn" value="<?php echo $printing_id; ?>" name="gray_issue_add_btn" onclick="printing_view(this.value);" class="btn btn-primary btn-xs"> Action </button>
                                    </td>
                                  </tr>
                                <?php 
                                  ++$sl;
...
<script type="text/javascript">
  function printing_view(printing_id)
  {
      var route_issue_id = document.getElementById("route_issue_id"+printing_id).value;
      var greige_issunce_id = document.getElementById("greige_issunce_id"+printing_id).value;
      var pp_no_id = document.getElementById("pp_no_id"+printing_id).value;
      var pp_details_id = document.getElementById("pp_details_id"+printing_id).value;

      $.ajax(
      {
          type: "POST",
          url: "details_printing_view.php",
          method: "POST",
          data: {route_issue_id: route_issue_id, greige_issunce_id: greige_issunce_id, pp_no_id: pp_no_id, pp_details_id: pp_details_id, printing_id: printing_id},
