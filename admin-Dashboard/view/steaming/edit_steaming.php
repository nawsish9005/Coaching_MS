                        ...
                        <form id="steaming_form" name="steaming_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <div class='input-group date' id='myDatepicker2'>
                                <input type='text' class="form-control" id="custom_date" name="custom_date" value="<?php echo $row_steaming['date']; ?>"/>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="b_batcher" name="b_batcher" value="<?php echo $row_steaming['b_batcher']; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="a_batcher" name="a_batcher" value="<?php echo $row_steaming['a_batcher']; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="p_width" name="p_width" value="<?php echo $row_steaming['p_width'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="p_qty" name="p_qty" value="<?php echo $row_steaming['p_qty'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="s_or_e" name="s_or_e" value="<?php echo $row_steaming['s_or_e'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
    ...
    <script type="text/javascript">
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          {
              var formdata = new FormData(document.getElementById('steaming_form'));
              formdata.append("route_issue_id", <?php echo $route_issue_id; ?> );
              formdata.append("steaming_id", <?php echo $steaming_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_steaming_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_steaming.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
