                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form id="singe_form" name="singe_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="total_quantity">Total Quantity (Meter) <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="total_quantity" name="total_quantity" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="time" name="time" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-5">
                              ...
                              <input type="text" id="rubbing_dry" name="rubbing_dry" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-5">
                              <span>Rubbing Wet</span>
                              <input type="text" id="rubbing_wet" name="rubbing_wet" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              $.ajax({
              type: "POST",
              url: "add_curing_steaming_saving.php",// add_curing_steaming_saving.php
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_curing_steaming.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
