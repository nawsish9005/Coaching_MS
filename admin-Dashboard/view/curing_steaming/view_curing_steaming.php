...
if (($greige_issunce_id == '') || (empty($greige_issunce_id)) || is_null($greige_issunce_id)||
  ($route_issue_id == '') || (empty($route_issue_id)) || is_null($route_issue_id)) {
   header("Location: printing_list.php");
}
?>
                          ...
                          <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php
                                ...
                                {
                                    $curing_id = $row_pp_details['curing_id'];
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td><?php echo $row_pp_details['machine'] ?></td>
                                    <td><?php echo $row_pp_details['time'] ?></td>
                                    <td><?php echo $row_pp_details['temp'] ?></td>
                                    <td><?php echo $row_pp_details['rubbing_dry'] ?></td>
                                    <td><?php echo $row_pp_details['rubbing_wet'] ?></td>
                                    <td>
                                        <input type="hidden" id="route_issue_id<?php echo $curing_id; ?>" name="route_issue_id<?php echo $curing_id; ?>" value="<?php echo $route_issue_id; ?>">
                                        <input type="hidden" id="greige_issunce_id<?php echo $curing_id; ?>" name="greige_issunce_id<?php echo $curing_id; ?>" value="<?php echo $greige_issunce_id; ?>">
                                        <input type="hidden" id="pp_no_id<?php echo $curing_id; ?>" name="pp_no_id<?php echo $curing_id; ?>" value="<?php echo $pp_no_id; ?>">
                                        <input type="hidden" id="pp_details_id<?php echo $curing_id; ?>" name="pp_details_id<?php echo $curing_id; ?>" value="<?php echo $pp_details_id; ?>">
                                        <button type="button" id="gray_issue_add_btn" value="<?php echo $curing_id; ?>" name="gray_issue_add_btn" onclick="curing_view(this.value);" class="btn btn-primary btn-xs"> Action </button>
                                    </td>
                                  </tr>
                                <?php 
                                  ++$sl;
...
<script type="text/javascript">
  function curing_view(curing_id)
  {
      var route_issue_id = document.getElementById("route_issue_id"+curing_id).value;
      var greige_issunce_id = document.getElementById("greige_issunce_id"+curing_id).value;
      var pp_no_id = document.getElementById("pp_no_id"+curing_id).value;
      var pp_details_id = document.getElementById("pp_details_id"+curing_id).value;

      $.ajax(
      {
          type: "POST",
          url: "details_curing_view.php",
          method: "POST",
          data: {route_issue_id: route_issue_id, greige_issunce_id: greige_issunce_id, pp_no_id: pp_no_id, pp_details_id: pp_details_id, curing_id: curing_id},
