...
$ready_for_print_id = $_POST['ready_for_print_id'];
                      ...
                      <div class="x_content">
                        ...
                        <?php
                          $sql_for_bleaching = "SELECT *
                                         ...
                                         AND ready_for_print_id = '$ready_for_print_id'
                                        ";
                        ...
                        <form id="singe_form" name="singe_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="bowing_and_skew" name="bowing_and_skew" value="<?php echo $row_bleaching['bowing_and_skew'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              formdata.append("ready_for_print_id", <?php echo $ready_for_print_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_ready_for_print_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_ready_for_print.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
