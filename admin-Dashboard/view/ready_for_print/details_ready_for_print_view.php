...
if ($route_issue_id == "" || is_null($route_issue_id) || empty($route_issue_id) || 
    $ready_for_print_id == "" || is_null($ready_for_print_id) || empty($ready_for_print_id)) 
{
    echo "No data found";
}
...
else
{
	?>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Ready for print Form View</h2>
                      ...
                      <div class="x_content">
                        ...
                        <form id="singe_form" name="singe_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="bowing_and_skew" name="bowing_and_skew" readonly value="<?php echo $row_bleaching['bowing_and_skew'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="remarks" readonly name="remarks" value="<?php echo $row_bleaching['remarks']; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>

                        </form>

                        <form action="edit_ready_for_print.php" method="post" style="display: inline; padding-left: 200px;">
                          <input type="hidden" id="route_issue_id" name="route_issue_id" value="<?php echo $route_issue_id; ?>">
                          <input type="hidden" id="ready_for_print_id" name="ready_for_print_id" value="<?php echo $ready_for_print_id; ?>">
