<?php 
	...
	$ready_for_dye_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['ready_for_dye_id'])));
	...
	$insert_pp_details_statement = "UPDATE `ready_for_dye` 
								    SET `date`= '$date',
								   		`b_batcher`= '$b_batcher',
								   		`a_batcher`= '$a_batcher',
								   		`p_width`= '$p_width',
								  ...
								  WHERE `route_issue_id` = '$route_issue_id' AND ready_for_dye_id = '$ready_for_dye_id' ";
