...
$ready_for_dye_id = $_POST['ready_for_dye_id'];
                      ...
                      <div class="x_content">
                        ...
                        <?php
                          $sql_for_bleaching = "SELECT *
                                         ...
                                         AND ready_for_dye_id = '$ready_for_dye_id'
                                        ";
     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              formdata.append("ready_for_dye_id", <?php echo $ready_for_dye_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_ready_for_dye_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_ready_for_dye.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
