...
if ($route_issue_id == "" || is_null($route_issue_id) || empty($route_issue_id) || 
    $ready_for_dye_id == "" || is_null($ready_for_dye_id) || empty($ready_for_dye_id)) 
{
    echo "No data found";
}
...
else
{
	?>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Ready for Dying Form View</h2>
                      ...
                      <div class="x_content">
                        ...
                        <form action="edit_ready_for_dye.php" method="post" style="display: inline; padding-left: 200px;">
                          <input type="hidden" id="route_issue_id" name="route_issue_id" value="<?php echo $route_issue_id; ?>">
                          <input type="hidden" id="ready_for_dye_id" name="ready_for_dye_id" value="<?php echo $ready_for_dye_id; ?>">
