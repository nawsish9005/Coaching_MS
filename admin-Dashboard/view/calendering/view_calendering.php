                          ...
                          <table class="table table-striped table-bordered">
                            <thead>
                              <tr>
                                ...
                                <th>Dimensional Change to Washing & Drying Warp (Befor Iron)</th>
                                <th>Dimensional Change to Washing & Drying Weft (Befor Iron)</th>
                                <th>Dimensional Change to Washing & Drying Warp (After Iron)</th>
                                <th>Dimensional Change to Washing & Drying Weft (After Iron)</th>
                                <th>Dimensional Change to Dry Cleaning Warp</th>
                                <th>Dimensional Change to Dry Cleaning Weft</th>
                                <th>Yarn Count for Warp</th>
                                <th>Yarn Count for Weft</th>
                                <th>Action</th>
                              </tr>
                            </thead>
                            ...
                            <tbody>
                              <?php
                                ...
                                {
                                    $calendering_id = $row_pp_details['calendering_id'];
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td><?php echo $row_pp_details['cf_rubbing_dry'] ?></td>
                                    <td><?php echo $row_pp_details['cf_rubbing_wet'] ?></td>
                                    <td><?php echo $row_pp_details['wash_dry_warp_before_iron'] ?></td>
                                    <td><?php echo $row_pp_details['wash_dry_weft_before_iron'] ?></td>
                                    <td><?php echo $row_pp_details['wash_dry_warp_after_iron'] ?></td>
                                    <td><?php echo $row_pp_details['wash_dry_weft_after_iron'] ?></td>
                                    <td><?php echo $row_pp_details['dry_cleaning_warp'] ?></td>
                                    <td><?php echo $row_pp_details['dry_cleaning_weft'] ?></td>
                                    <td><?php echo $row_pp_details['yarn_count_warp'] ?></td>
                                    <td><?php echo $row_pp_details['yarn_count_weft'] ?></td>

                                    <td>
                                        <input type="hidden" id="route_issue_id<?php echo $calendering_id; ?>" name="route_issue_id<?php echo $calendering_id; ?>" value="<?php echo $route_issue_id; ?>">
                                        <input type="hidden" id="greige_issunce_id<?php echo $calendering_id; ?>" name="greige_issunce_id<?php echo $calendering_id; ?>" value="<?php echo $greige_issunce_id; ?>">
                                        <input type="hidden" id="pp_no_id<?php echo $calendering_id; ?>" name="pp_no_id<?php echo $calendering_id; ?>" value="<?php echo $pp_no_id; ?>">
                                        <input type="hidden" id="pp_details_id<?php echo $calendering_id; ?>" name="pp_details_id<?php echo $calendering_id; ?>" value="<?php echo $pp_details_id; ?>">
                                        <button type="button" id="gray_issue_add_btn" value="<?php echo $calendering_id; ?>" name="gray_issue_add_btn" onclick="calendering_view(this.value);" class="btn btn-primary btn-xs"> Action </button>
                                    </td>
                                  </tr>
                                <?php 
                                  ++$sl;
...
<script type="text/javascript">
  function calendering_view(calendering_id)
  {
      var route_issue_id = document.getElementById("route_issue_id"+calendering_id).value;
      var greige_issunce_id = document.getElementById("greige_issunce_id"+calendering_id).value;
      var pp_no_id = document.getElementById("pp_no_id"+calendering_id).value;
      var pp_details_id = document.getElementById("pp_details_id"+calendering_id).value;

      $.ajax(
      {
          type: "POST",
          url: "details_calendering_view.php",
          method: "POST",
          data: {route_issue_id: route_issue_id, greige_issunce_id: greige_issunce_id, pp_no_id: pp_no_id, pp_details_id: pp_details_id, calendering_id: calendering_id},
