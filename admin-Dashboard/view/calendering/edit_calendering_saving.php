<?php 
	...
	$calendering_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['calendering_id'])));
	...
	$insert_pp_details_statement = "UPDATE `calendering` 
								    SET `date`= '$date',
								   		`b_batcher`= '$b_batcher',
								   		`a_batcher`= '$a_batcher',
								   		`p_width`= '$p_width',
								  ...
								  WHERE `route_issue_id` = '$route_issue_id' AND calendering_id='$calendering_id' ";
