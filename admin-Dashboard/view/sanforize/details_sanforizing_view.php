...
if ($route_issue_id == "" || is_null($route_issue_id) || empty($route_issue_id) || 
    $sanforizing_id == "" || is_null($sanforizing_id) || empty($sanforizing_id)) 
{
    echo "No data found";
}
...
else
{
 ...
 <br>
                        ...
                        <form action="edit_sanforizing.php" method="post" style="display: inline; padding-left: 200px;">
                          <input type="hidden" id="route_issue_id" name="route_issue_id" value="<?php echo $route_issue_id; ?>">
        				          <input type="hidden" id="sanforizing_id" name="sanforizing_id" value="<?php echo $sanforizing_id; ?>">
