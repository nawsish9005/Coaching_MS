...
if (($greige_issunce_id == '') || (empty($greige_issunce_id)) || is_null($greige_issunce_id)||
  ($route_issue_id == '') || (empty($route_issue_id)) || is_null($route_issue_id)) {
   header("Location: sanforizing_list.php");
}
?>
        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main" style="margin-bottom: 10px;">
              <div class="">
                ...
                <?php 
                    $sql_for_sanforizing_standard = "SELECT *
                    ...
                    $row_for_sanforizing_standard = mysqli_fetch_array($res_for_sanforizing_standard);
                ?>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form id="sanforizing_form" name="sanforizing_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="yarn_count_warp">Yarn Count for Warp <span class="required">*</span> ( <?php echo $row_for_sanforizing_standard['yarn_count_warp_unit'] ?> )
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="yarn_count_weft">Yarn Count for Weft <span class="required">*</span> ( <?php echo $row_for_sanforizing_standard['yarn_count_weft_unit'] ?> )
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number_thread_warp">Number of Threads Warp <span class="required">*</span> ( <?php echo $row_for_sanforizing_standard['number_thread_warp_unit'] ?> )
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number_thread_weft">Number of Threads weft <span class="required">*</span> ( <?php echo $row_for_sanforizing_standard['number_thread_weft_unit'] ?> )
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mass_per_unit_per_area">Mass per Unit per Area <span class="required">*</span> ( <?php echo $row_for_sanforizing_standard['mass_per_unit_per_area_unit'] ?> )
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tensile_warp">Tensile Properties Warp ( <?php echo $row_for_sanforizing_standard['tensile_warp_unit'] ?> ) 
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tensile_weft">Tensile Properties Weft ( <?php echo $row_for_sanforizing_standard['tensile_weft_unit'] ?> ) 
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tear_force_warp">Tear Force Warp ( <?php echo $row_for_sanforizing_standard['tear_force_warp_unit'] ?> ) 
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tear_force_weft">Tear Force Weft ( <?php echo $row_for_sanforizing_standard['tear_force_weft_unit'] ?> ) 
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="seam_strength_warp">Seam Strength Warp ( <?php echo $row_for_sanforizing_standard['seam_strength_warp_unit'] ?> ) 
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="seam_strength_weft">Seam Strength Weft ( <?php echo $row_for_sanforizing_standard['seam_strength_weft_unit'] ?> )
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php
                                if ($row_for_sanforizing_standard['seam_resistance_method1_warp_value2'] != 0)
                                {
                                    ?>
                                      <div class="form-group">
                          ...
                          <?php 
                                if ($row_for_sanforizing_standard['seam_resistance_method1_weft_value2'] != 0)
                                {
                                    ?>
                                      <div class="form-group">
                          ...
                          <?php 
                              if ($row_for_sanforizing_standard['seam_resistance_method2_warp_value2'] != 0)
                              {
                                  ?>
                                    <div class="form-group">
                          ...
                          <?php 
                              if ($row_for_sanforizing_standard['seam_resistance_method2_weft_value2'] != 0)
                              {
                                  ?>
                                    <div class="form-group">
    ...
    <script type="text/javascript">
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          {
              var formdata = new FormData(document.getElementById('sanforizing_form'));
              formdata.append("route_issue_id", <?php echo $route_issue_id; ?> );
              $.ajax({
              type: "POST",
              url: "add_sanforizing_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
