<?php 
	...
	$scouring_bleaching_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['scouring_bleaching_id'])));
	...
	$insert_pp_details_statement = "UPDATE `scouring_bleaching` 
								    SET `date`= '$date',
								   		`b_batcher`= '$b_batcher',
								   		`a_batcher`= '$a_batcher',
								   		`p_width`= '$p_width',
								  ...
								  WHERE `route_issue_id` = '$route_issue_id' AND scouring_bleaching_id='$scouring_bleaching_id' ";
