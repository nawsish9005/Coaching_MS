                          ...
                          <table class="table table-striped table-bordered">
                            <thead>
                              <tr>
                                ...
                                <th>Size Center</th>
                                <th>Size Right</th>
                                <th>Whiteness Left</th>
                                <th>Whiteness Center</th>
                                <th>Whiteness Right</th>
                                <th>Piling</th>
                                <th>pH Left</th>
                                <th>pH Center</th>
                                <th>pH Right</th>
                            ...
                            <tbody>
                              <?php
                                ...
                                {
                                    $bleaching_id = $row_pp_details['scouring_bleaching_id'];
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td><?php echo $row_pp_details['absorbency_left'] ?></td>
                                    <td><?php echo $row_pp_details['absorbency_center'] ?></td>
                                    <td><?php echo $row_pp_details['absorbency_right'] ?></td>
                                    <td><?php echo $row_pp_details['size_left'] ?></td>
                                    <td><?php echo $row_pp_details['size_center'] ?></td>
                                    <td><?php echo $row_pp_details['size_right'] ?></td>
                                    <td><?php echo $row_pp_details['whiteness_left'] ?></td>
                                    <td><?php echo $row_pp_details['whiteness_center'] ?></td>
                                    <td><?php echo $row_pp_details['whiteness_right'] ?></td>
                                    <td><?php echo $row_pp_details['pilling'] ?></td>
                                    <td><?php echo $row_pp_details['ph_left'] ?></td>
                                    <td><?php echo $row_pp_details['ph_center'] ?></td>
                                    <td><?php echo $row_pp_details['ph_right'] ?></td>
                                    <td>
                                        <input type="hidden" id="route_issue_id<?php echo $bleaching_id; ?>" name="route_issue_id<?php echo $bleaching_id; ?>" value="<?php echo $route_issue_id; ?>">
                                        <input type="hidden" id="greige_issunce_id<?php echo $bleaching_id; ?>" name="greige_issunce_id<?php echo $bleaching_id; ?>" value="<?php echo $greige_issunce_id; ?>">
                                        <input type="hidden" id="pp_no_id<?php echo $bleaching_id; ?>" name="pp_no_id<?php echo $bleaching_id; ?>" value="<?php echo $pp_no_id; ?>">
                                        <input type="hidden" id="pp_details_id<?php echo $bleaching_id; ?>" name="pp_details_id<?php echo $bleaching_id; ?>" value="<?php echo $pp_details_id; ?>">
                                        <button type="button" id="gray_issue_add_btn" value="<?php echo $bleaching_id; ?>" name="gray_issue_add_btn" onclick="scouring_bleaching_view(this.value);" class="btn btn-primary btn-xs"> Action </button>
                                    </td>
                                  </tr>
                                <?php 
                                  ++$sl;
...
<script type="text/javascript">
  function scouring_bleaching_view(scouring_bleaching_id)
  {
      var route_issue_id = document.getElementById("route_issue_id"+scouring_bleaching_id).value;
      var greige_issunce_id = document.getElementById("greige_issunce_id"+scouring_bleaching_id).value;
      var pp_no_id = document.getElementById("pp_no_id"+scouring_bleaching_id).value;
      var pp_details_id = document.getElementById("pp_details_id"+scouring_bleaching_id).value;

      $.ajax(
      {
          type: "POST",
          url: "details_scouring_bleaching_view.php",
          method: "POST",
          data: {route_issue_id: route_issue_id, greige_issunce_id: greige_issunce_id, pp_no_id: pp_no_id, pp_details_id: pp_details_id, scouring_bleaching_id: scouring_bleaching_id},
