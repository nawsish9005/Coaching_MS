                        ...
                        <form id="singe_form" name="singe_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="absorbency_left" name="absorbency_left" value="<?php echo $row_bleaching['absorbency_left'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="absorbency_center" name="absorbency_center" value="<?php echo $row_bleaching['absorbency_center'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="absorbency_right" name="absorbency_right" value="<?php echo $row_bleaching['absorbency_right'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="size_left" name="size_left" value="<?php echo $row_bleaching['size_left'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="size_center" name="size_center" value="<?php echo $row_bleaching['size_center'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="size_right" name="size_right" value="<?php echo $row_bleaching['size_right'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="whiteness_left" name="whiteness_left" value="<?php echo $row_bleaching['whiteness_left'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="whiteness_center" name="whiteness_center" value="<?php echo $row_bleaching['whiteness_center'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="whiteness_right" name="whiteness_right" value="<?php echo $row_bleaching['whiteness_right'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="pilling" name="pilling" value="<?php echo $row_bleaching['pilling'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="ph_left" name="ph_left" value="<?php echo $row_bleaching['ph_left'];?>" class="form-control col-md-7 col-xs-12">
                              <input type="hidden" id="route_issue_id" name="route_issue_id" value="<?php echo $route_issue_id; ?>">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="ph_center" name="ph_center" value="<?php echo $row_bleaching['ph_center'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="ph_right" name="ph_right" value="<?php echo $row_bleaching['ph_right'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              formdata.append("scouring_bleaching_id", <?php echo $scouring_bleaching_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_scouring_bleaching_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_scouring_bleaching.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
