<?php 
	...
	// { 
		...
		$insert_sql_statement = "UPDATE `construction` 

		                            SET `yarn_count_warp_value`='$yarn_count_warp_value',
		                                `yarn_count_weft_value`='$yarn_count_weft_value', 
		                                `yarn_count_warp_ply`='$yarn_count_warp_ply', 
			                             `yarn_count_weft_ply`='$yarn_count_weft_ply',
			                             `yarn_count_warp_unit`='$yarn_count_warp_unit', 
			                             `yarn_count_weft_unit`='$yarn_count_weft_unit', 
			                             `thread_count_warp_value`='$thread_count_warp_value', 
			                             `thread_count_weft_value`='$thread_count_weft_value', 
			                             `thread_count_warp_insertion`='$thread_count_warp_insertion', 
			                             `thread_count_weft_insertion`='$thread_count_weft_insertion' 
