<?php 
	...
	//check duplicate
	$sql_for_duplicate = "SELECT * FROM `process` WHERE `process_name` = '$process'";
	...
	{ 
		...
		$insert_sql_statement = "UPDATE `process` SET `process_name`='$process' WHERE `process_id`='$process_id'";
