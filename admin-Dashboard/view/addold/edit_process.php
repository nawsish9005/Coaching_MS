                        ...
                        <form id="add_process_form" name="add_process_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="process" name="process" value="<?php echo $row['process_name'] ?>" class="form-control col-md-7 col-xs-12">
     ...
     $(document).ready(function(){ 
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              $.ajax({
              type: "POST",
              url: "edit_process_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
