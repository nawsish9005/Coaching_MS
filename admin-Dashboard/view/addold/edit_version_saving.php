<?php 
	...
	//check duplicate
	$sql_for_duplicate = "SELECT * FROM `version` WHERE `version_name` = '$version'";
	...
	{ 
		...
		$insert_sql_statement = "UPDATE `version` SET `version_name`='$version' WHERE `version_id`='$version_id'";
