              ...
              <div class="">
                <div class="page-title">
                  <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>Process Technique (Program Type) Lists </li>
                    </ol>
                  </div>
                </div>
                ...
                <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <a type="button" href="add_process.php" class="btn btn-primary btn-xs"> Add New Program Type </a>
                        <div class="x_title">
                        ...
                        <div class="x_content">
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php 
                                $s1 = 1;
                                $sql_for_process = "SELECT * FROM process";
                              ...
                              <tr>
                                ...
                                <td>
                                  <form action="edit_process.php" method="post" style="display: inline;">
