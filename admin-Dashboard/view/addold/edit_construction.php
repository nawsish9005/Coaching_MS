...
$sql = "SELECT * FROM construction WHERE construction_id = '$construction_id'";
                      ...
                      <div class="x_content">
                        ...
                        <form id="add_construction_form" name="add_construction_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="yarn_count_warp_value" name="yarn_count_warp_value" value="<?php echo $row['yarn_count_warp_value'] ?>"  class="form-control col-md-7 col-xs-12">
                              <input type="hidden" id="construction_id" name="construction_id" value="<?php echo $row['construction_id'] ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="yarn_count_warp_ply" name="yarn_count_warp_ply" class="yarn_count_warp_ply form-control col-md-12 col-xs-12">
                                <option value="1" selected <?php echo ($row['yarn_count_warp_ply'] == '1') ? 'selected' : '' ?> >1</option>
                                <option value="2" <?php echo ($row['yarn_count_warp_ply'] == '2') ? 'selected' : '' ?> >2</option>
                                <option value="3" <?php echo ($row['yarn_count_warp_ply'] == '3') ? 'selected' : '' ?> >3</option>
                                <option value="4" <?php echo ($row['yarn_count_warp_ply'] == '4') ? 'selected' : '' ?> >4</option>
                              </select> 
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="yarn_count_warp_unit" name="yarn_count_warp_unit" class="yarn_count_warp_unit form-control col-md-12 col-xs-12">
                                <option value="Ne" selected <?php echo ($row['yarn_count_warp_unit'] == 'Ne') ? 'selected' : '' ?> >Ne</option>
                                <option value="Nm" <?php echo ($row['yarn_count_warp_unit'] == 'Nm') ? 'selected' : '' ?> >Nm</option>
                                <option value="Den" <?php echo ($row['yarn_count_warp_unit'] == 'Den') ? 'selected' : '' ?> >Den</option>
                                <option value="Tex" <?php echo ($row['yarn_count_warp_unit'] == 'Tex') ? 'selected' : '' ?> >Tex</option>
                                <option value="Dtex" <?php echo ($row['yarn_count_warp_unit'] == 'Dtex') ? 'selected' : '' ?> >Dtex</option>
                              </select> 
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="yarn_count_weft_value" name="yarn_count_weft_value" value="<?php echo $row['yarn_count_weft_value'] ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="yarn_count_weft_ply" name="yarn_count_weft_ply" class="yarn_count_weft_ply form-control col-md-12 col-xs-12">
                                <option value="1" selected <?php echo ($row['yarn_count_weft_ply'] == '1') ? 'selected' : '' ?> >1</option>
                                <option value="2" <?php echo ($row['yarn_count_weft_ply'] == '2') ? 'selected' : '' ?> >2</option>
                                <option value="3" <?php echo ($row['yarn_count_weft_ply'] == '3') ? 'selected' : '' ?> >3</option>
                                <option value="4" <?php echo ($row['yarn_count_weft_ply'] == '4') ? 'selected' : '' ?> >4</option>
                              </select> 
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="yarn_count_weft_unit" name="yarn_count_weft_unit" class="yarn_count_weft_unit form-control col-md-12 col-xs-12">
                                <option value="Ne" selected <?php echo ($row['yarn_count_weft_unit'] == 'Ne') ? 'selected' : '' ?> >Ne</option>
                                <option value="Nm" <?php echo ($row['yarn_count_weft_unit'] == 'Nm') ? 'selected' : '' ?> >Nm</option>
                                <option value="Den" <?php echo ($row['yarn_count_weft_unit'] == 'Den') ? 'selected' : '' ?> >Den</option>
                                <option value="Tex" <?php echo ($row['yarn_count_weft_unit'] == 'Tex') ? 'selected' : '' ?> >Tex</option>
                                <option value="Dtex" <?php echo ($row['yarn_count_weft_unit'] == 'Dtex') ? 'selected' : '' ?> >Dtex</option>
                              </select> 
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="thread_count_warp_value" name="thread_count_warp_value" value="<?php echo $row['thread_count_warp_value'] ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="thread_count_warp_insertion" name="thread_count_warp_insertion" class="thread_count_warp_insertion form-control col-md-12 col-xs-12">
                                <option value="1" selected <?php echo ($row['thread_count_warp_insertion'] == '1') ? 'selected' : '' ?> >1</option>
                                <option value="2" <?php echo ($row['thread_count_warp_insertion'] == '2') ? 'selected' : '' ?> >2</option>
                                <option value="3" <?php echo ($row['thread_count_warp_insertion'] == '3') ? 'selected' : '' ?> >3</option>
                                <option value="4" <?php echo ($row['thread_count_warp_insertion'] == '4') ? 'selected' : '' ?> >4</option>
                              </select> 
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="thread_count_weft_value" name="thread_count_weft_value" value="<?php echo $row['thread_count_weft_value'] ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="thread_count_weft_insertion" name="thread_count_weft_insertion" class="thread_count_weft_insertion form-control col-md-12 col-xs-12">
                                <option value="1" selected <?php echo ($row['thread_count_weft_insertion'] == '1') ? 'selected' : '' ?> >1</option>
                                <option value="2" <?php echo ($row['thread_count_weft_insertion'] == '2') ? 'selected' : '' ?> >2</option>
                                <option value="3" <?php echo ($row['thread_count_weft_insertion'] == '3') ? 'selected' : '' ?> >3</option>
                                <option value="4" <?php echo ($row['thread_count_weft_insertion'] == '4') ? 'selected' : '' ?> >4</option>
                              </select> 
                            </div>
                          </div>
