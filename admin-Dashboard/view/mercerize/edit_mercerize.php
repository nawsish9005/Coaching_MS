     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              formdata.append("mercerize_id", <?php echo $mercerize_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_mercerize_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_mercerize.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
