<?php 
	...
	$mercerize_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['mercerize_id'])));
	...
	$insert_pp_details_statement = "UPDATE `mercerize` 
								    SET `date`= '$date',
								   		`b_batcher`= '$b_batcher',
								   		`a_batcher`= '$a_batcher',
								   		`p_width`= '$p_width',
								  ...
								  WHERE `route_issue_id` = '$route_issue_id' AND `mercerize_id` = '$mercerize_id'";
