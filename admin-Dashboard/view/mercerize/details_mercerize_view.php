...
if ($route_issue_id == "" || is_null($route_issue_id) || empty($route_issue_id) || 
    $mercerize_id == "" || is_null($mercerize_id) || empty($mercerize_id)) 
{
    echo "No data found";
}
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form action="edit_mercerize.php" method="post" style="display: inline; padding-left: 200px;">
                          <input type="hidden" id="route_issue_id" name="route_issue_id" value="<?php echo $route_issue_id; ?>">
                          <input type="hidden" id="mercerize_id" name="mercerize_id" value="<?php echo $mercerize_id; ?>">
