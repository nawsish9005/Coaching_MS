              ...
              <div class="">
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Singing and Desize Add Form</h2>
                        ...
                        <form id="singe_form" name="singe_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="batcher" name="batcher" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="m_c_name" name="m_c_name" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="flame" name="flame" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="speed" name="speed" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="temp" name="temp" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <!-- <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="singe_quality" name="singe_quality" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div> -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="ph" name="ph" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="visual_assessment" name="visual_assessment" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
    ...
    <script type="text/javascript">
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          // else if(document.getElementById("singe_quality").value == "")
          // {
          //     missing_alert("singe_quality");
          //     return false;
          // }
          // else if(isNaN(document.getElementById("singe_quality").value))
          // {
          //   missing_alert_2("singe_quality","singe_quality");
          //   return false;
          // }
          ...
          else
          {
              ...
              $.ajax({
              type: "POST",
              url: "add_singe_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
