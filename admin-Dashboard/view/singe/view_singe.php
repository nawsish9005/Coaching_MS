                          ...
                          <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php
                                ...
                                {
                                    $singe_id = $row_pp_details['singe_id'];
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                      <?php echo $row_pp_details['batcher'] ?>
                                    </td>
                                    <td><?php echo $row_pp_details['p_width'] ?></td>
                                    <td><?php echo $row_pp_details['p_qty'] ?></td>
                                    <td><?php echo $row_pp_details['m_c_name'] ?></td>
                                    <td><?php echo $row_pp_details['flame'] ?></td>
                                    <td><?php echo $row_pp_details['speed'] ?></td>
                                    <td><?php echo $row_pp_details['temp'] ?></td>
                                    <td><?php echo $row_pp_details['ph'] ?></td>
                                    <td>
                                        <input type="hidden" id="route_issue_id<?php echo $singe_id; ?>" name="route_issue_id<?php echo $singe_id; ?>" value="<?php echo $route_issue_id; ?>">
                                        <input type="hidden" id="greige_issunce_id<?php echo $singe_id; ?>" name="greige_issunce_id<?php echo $singe_id; ?>" value="<?php echo $greige_issunce_id; ?>">
                                        <input type="hidden" id="pp_no_id<?php echo $singe_id; ?>" name="pp_no_id<?php echo $singe_id; ?>" value="<?php echo $pp_no_id; ?>">
                                        <input type="hidden" id="pp_details_id<?php echo $singe_id; ?>" name="pp_details_id<?php echo $singe_id; ?>" value="<?php echo $pp_details_id; ?>">
                                        <button type="button" id="gray_issue_add_btn" value="<?php echo $singe_id; ?>" name="gray_issue_add_btn" onclick="singe_view(this.value);" class="btn btn-primary btn-xs"> Action </button>
                                    </td>
                                  </tr>
                                <?php 
                                  ++$sl;
...
<script type="text/javascript">
  function singe_view(singe_id)
  {
      var route_issue_id = document.getElementById("route_issue_id"+singe_id).value;
      var greige_issunce_id = document.getElementById("greige_issunce_id"+singe_id).value;
      var pp_no_id = document.getElementById("pp_no_id"+singe_id).value;
      var pp_details_id = document.getElementById("pp_details_id"+singe_id).value;

      $.ajax(
      {
          type: "POST",
          url: "details_singe_view.php",
          method: "POST",
          data: {route_issue_id: route_issue_id, greige_issunce_id: greige_issunce_id, pp_no_id: pp_no_id, pp_details_id: pp_details_id, singe_id: singe_id},
