                          ...
                          <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php
                                ...
                                {
                                    $bleaching_id = $row_pp_details['bleaching_id'];
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" id="gray_issue_add_btn" value="<?php echo $bleaching_id; ?>" name="gray_issue_add_btn" onclick="bleaching_view(this.value);" class="btn btn-primary btn-xs"> Action </button>
                                    </td>
                                  </tr>
                                <?php 
                                  ++$sl;
...
<script type="text/javascript">
  function bleaching_view(bleaching_id)
  {
      var route_issue_id = document.getElementById("route_issue_id"+bleaching_id).value;
      var greige_issunce_id = document.getElementById("greige_issunce_id"+bleaching_id).value;
      var pp_no_id = document.getElementById("pp_no_id"+bleaching_id).value;
      var pp_details_id = document.getElementById("pp_details_id"+bleaching_id).value;

      $.ajax(
      {
          type: "POST",
          url: "details_bleaching_view.php",
          method: "POST",
          data: {route_issue_id: route_issue_id, greige_issunce_id: greige_issunce_id, pp_no_id: pp_no_id, pp_details_id: pp_details_id, bleaching_id: bleaching_id},
