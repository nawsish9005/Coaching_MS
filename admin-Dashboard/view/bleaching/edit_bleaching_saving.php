<?php 
	...
	$bleaching_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['bleaching_id'])));
	...
	$insert_pp_details_statement = "UPDATE `bleaching` 
								    SET `date`= '$date',
								   		`b_batcher`= '$b_batcher',
								   		`a_batcher`= '$a_batcher',
								   		`p_width`= '$p_width',
								  ...
								  WHERE `route_issue_id` = '$route_issue_id' AND bleaching_id='$bleaching_id' ";
