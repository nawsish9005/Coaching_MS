              ...
              <div class="">
                <div class="page-title">
                  <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>Settings</li>
                        <li><a href="add_graphics_basic.php">Add Subject</a></li>
                        <li>Subjects Lists</li>
                    </ol>
                  </div>
                </div>
                ...
                <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <a type="button" href="add_graphics.php" class="btn btn-primary btn-xs"> Add New Subject</a>
                        <div class="x_title">
