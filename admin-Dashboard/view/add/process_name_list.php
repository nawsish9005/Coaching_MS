              ...
              <div class="">
                ...
                <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <a type="button" href="add_process_name.php" class="btn btn-primary btn-xs"> Add New Process Name</a>
                        <div class="x_title">
                          <h2>Process</h2>
                        ...
                        <div class="x_content">
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php 
                                $s1 = 1;
                                $sql_for_route = "SELECT * FROM process_name";
                              ...
                              <tr>
                                ...
                                <td>
                                  <form action="edit_process_name.php" method="post" style="display: inline;">
