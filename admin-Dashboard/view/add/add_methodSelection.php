...
$sql = "SELECT * FROM customer WHERE customer_id = '$customers_id'";
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <?php
                                  ...
                                  while ($customers_row = mysqli_fetch_assoc($customers_res)) 
                                  {
                                      ...
                                      if ($customers_row['customer_name']==$row['customer_name']) {
                                        # code...
                                        echo "<option selected='selected' value='".$customers_row['customer_name']."'>";
                                      ...
                                      {
                                         echo "<option value='".$customers_row['customer_name']."'>";
                              ...
                              <input type="hidden" id="customers_name" name="customers_name" value="<?php echo $row['customer_name'] ?>">
                        ...
                        <div class="x_content">
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              ...
                              <?php                                
                                $s1 = 1;
 $customers_nameCheck= $row['customer_name'] ;



                                 $sql_for_color = "SELECT * FROM test_method_name";
                              ...
                              <tr>
                                ...
                                <td> <input id="demo1" class="form-check-input" type="checkbox"  name="copy_test_box_select" value="<?php echo $row['test_method_id'];?>" 

                                  <?php     
                                    $saveNameIDCheck=$row['test_method_id'];

                                   $sql_for_duplicate = "SELECT * FROM `customer_selection` WHERE `test_method_id`='$saveNameIDCheck' and `customer_name`='$customers_nameCheck' "; 
                                ...
                                <td>
                                   ...
                                   <input type="hidden" id="color_id" name="color_id" value="<?php echo $row['test_method_id']; ?>">
                              ...
                              <tr>
                                ...
                                <td>
                                  <form action="methodSelection.php" method="post" >
                                    <input type="hidden" id="customers_id" name="customers_id" value="<?php echo $row['customer_id']; ?>">
      ...
      function selection12()
      {
              ...
              if(document.getElementById("demo2").value == "")
          {
              ...
              success: function(data) 
              {
                   ...
                   //info_alert(data);
                   window.location = "add_methodSelection.php";
