...
$sql = "SELECT * FROM test_method_name where test_method_id = '$color_id'";
//$sql = "SELECT * FROM test_name WHERE name_ID = '$color_id'";
                        ...
                        <form id="add_color_form" name="add_color_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <!-- <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="testname" name="testname" value="<?php  echo $row['test_name']?>" class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">                              
                              ...
                              <select  id="testname" name="testname" class="customer_issue select2 form-control col-md-12 col-xs-12">
                                ...
                                <?php
                                  ...
                                  $customers_sql = "SELECT * FROM test_name ";
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="testmethod" name="testmethod" value="<?php  echo $row['test_method_name']?>" class="form-control col-md-7 col-xs-12">
        


                              <input type="hidden" id="saveNameID" name="saveNameID" value="<?php echo $row['test_method_id'] ?>">
