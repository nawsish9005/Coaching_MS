                        ...
                        <div class="x_content">
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php 
                                $s1 = 1;
                                $sql_for_version = "SELECT * FROM version_name";

                                $res_for_version = mysqli_query($con, $sql_for_version);

                                while ($row = mysqli_fetch_assoc($res_for_version)) 
                                {
                              ?>
                              <tr>
                                <td><?php echo $s1; ?></td>
                                ...
                                <td>
                                  <form action="edit_version.php" method="post" style="display: inline;">
     ...
     $(document).ready(function(){ 
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              $.ajax({
              type: "POST",
              url: "add_version_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
