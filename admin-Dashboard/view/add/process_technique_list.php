              ...
              <div class="">
                <div class="page-title">
                  <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>Settings</li>
                        <li><a href="add_process_technique.php">Add Process Technique (Program Type)</a></li>
                ...
                <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <a type="button" href="add_process_technique.php" class="btn btn-primary btn-xs"> Add New Program Type </a>
                        <div class="x_title">
