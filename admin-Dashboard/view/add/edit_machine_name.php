                ...
                <div class="page-title">
                  <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>Settings</li>
                        <li><a href="add_machine_name.php">Add Machine Name</a></li>
                        <li>Edit Machine Name</li>
                    </ol>
                  </div>
                </div>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form id="edit_machine_name_form" name="edit_machine_name_form" data-parsley-validate class="form-horizontal form-label-left">

                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="machine_name">Machine Name <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="machine_name" name="machine_name" value="<?php echo $row['machine_name'] ?>" class="form-control col-md-7 col-xs-12">
    ...
    <script type="text/javascript">
     ...
     $(document).ready(function(){ 
      ...
      $('#submit').click(function()
      {
          ...
          else if(document.getElementById("process_id").value == "")
          {
              missing_alert("process_id");
              return false;
          }
          else
          {
              var formdata = new FormData(document.getElementById('edit_machine_name_form'));
              $.ajax({
              type: "POST",
              url: "edit_machine_name_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
