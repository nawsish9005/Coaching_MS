              ...
              <div class="">
                ...
                <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <a type="button" href="add_machine_name.php" class="btn btn-primary btn-xs"> Add New Machine Name</a>
                        <div class="x_title">
                          <h2>Machine</h2>
                              ...
                              <tr>
                                ...
                                <td>
                                  <form action="edit_machine_name.php" method="post" style="display: inline;">
                                    ...
                                    <button type="submit" id="machine_name_edit_btn" name="machine_name_edit_btn" class="btn btn-primary btn-xs"> Edit </button>
                                  </form>
                                </td>
                              </tr>
                              <?php 
