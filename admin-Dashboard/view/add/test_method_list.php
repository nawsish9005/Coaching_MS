              ...
              <div class="">
                <div class="page-title">
                  <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>Settings</li>
                        <li><a href="add_test_method.php">Add Test Method Name</a></li>
                        <li>Test Method Name Lists</li>
                    </ol>
                  </div>
                </div>
                <!-- main content again -->
                ...
                <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <a type="button" href="add_test_method.php" class="btn btn-primary btn-xs"> Add New Test Method </a>
