                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="route_id" name="route_id" class="route_id_issue select2 form-control col-md-12 col-xs-12">
                                ...
                                <?php
                                  ...
                                  {
                                      ?>
                                          <option <?php if($process_row['process_id'] == $route_id ){echo "selected";}?> value="<?php echo $process_row['process_id'];?>"> <?php echo $process_row['route_name'];?></option>
                                      <?php
                                  }
                                ?>
                              </select>
