...
$sql_for_gray_variable = "SELECT * FROM defining_calendering_qc_standard WHERE pp_no_id = '$pp_no_id' AND pp_details_id = '$pp_details_id' AND active = '1' ";
    ...
    <form id="calendering_variable_form" name="calendering_variable_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">n
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <button type="button" name="submit" id="submit" onclick="update_edit_calendering_standard_data('<?php echo $pp_details_id; ?>');" class="btn btn-success" >Update</button>
