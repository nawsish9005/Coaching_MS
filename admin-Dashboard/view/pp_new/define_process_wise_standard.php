                            ...
                            <div class="col-md-10 col-sm-9 col-xs-12">
                              <select id="customers_model" name="customers_model" class="model_action select2 pp_number form-control col-md-12 col-xs-12" onchange="">
                                ...
                                <?php
                                  ...
                                  {
                                      echo "<option value='".$customers_row['customer_id']."'>";
                                      echo $customers_row['customer_name'];
                                      echo "</option>";
                                  }
                                ?>
                              </select> 
...
<script type="text/javascript" src="validation_for_standard_of_ready_for_print.js"></script>
<script type="text/javascript" src="validation_for_standard_of_ready_for_dying.js"></script>
...
function tensile_warp_condition_before()
{
    var tensile_warp_value = document.getElementById("tensile_warp_value").value;
    var tensile_warp_cond = document.getElementById("tensile_warp_cond").value;
