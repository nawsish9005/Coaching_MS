                      ...
                      <div class="x_content">
                        <form id="define-standard-form" action="" method="" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <?php 
                                  $pp_details_sql = "SELECT * FROM pp_details WHERE pp_id = '$pp_version'";
                                  $pp_details_res = mysqli_query($con, $pp_details_sql) or die(mysqli_error($con));
                                  $pp_details_row = mysqli_fetch_assoc($pp_details_res);
                              ?>
                              <input id="pp_details_id" readonly name="pp_details_id" value="<?php echo $pp_details_row['version']; ?>" class="form-control col-md-12 col-xs-12" type="text">
                              <input id="pp_version" readonly name="pp_version" value="<?php echo $pp_version; ?>" class="form-control col-md-12 col-xs-12" type="hidden">
                            </div>
                          </div>
                          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <select disabled id="pp_version_standard" name="pp_version_standard" class="pp_version_standard select2 pp_number form-control col-md-12 col-xs-12">
                                <?php 
                                  if ($process_number == 1) 
                                  {
                                      ?>
...
<script type="text/javascript">
  ...
  function edit_for_bleaching_standard(pp_details_id)
  {
      var pp_no = document.getElementById("pp_no").value;
      var color = document.getElementById("color").value;
      var version = document.getElementById("version").value;
...
function send_data_of_define_standard_of_finishing_form_to_database(pp_version_id)
  ...
  function edit_for_finishing_standard(pp_version)
  {
      var pp_no = document.getElementById("pp_no").value;
      var color = document.getElementById("color").value;
      var version = document.getElementById("version").value;
...
function edit_for_scouring_standard(pp_details_id)
  {
      var pp_no = document.getElementById("pp_no").value;
      var color = document.getElementById("color").value;
      var version = document.getElementById("version").value;
...
function update_edit_scouring_standard_data(pp_version_id)
  ...
  function edit_for_scouring_bleaching_standard(pp_details_id)
  {
      var pp_no = document.getElementById("pp_no").value;
      var color = document.getElementById("color").value;
      var version = document.getElementById("version").value;
...
function send_data_of_define_standard_of_washing_form_to_database(pp_version_id)
  ...
  function edit_for_washing_standard(pp_version)
  {
      var pp_no = document.getElementById("pp_no").value;
      var color = document.getElementById("color").value;
      var version = document.getElementById("version").value;
  ...
  function edit_for_calendering_standard(pp_version)
  {
      var pp_no = document.getElementById("pp_no").value;
      var color = document.getElementById("color").value;
      var version = document.getElementById("version").value;
  ...
  function edit_for_sanforizing_standard(pp_version)
  {
      var pp_no = document.getElementById("pp_no").value;
      var color = document.getElementById("color").value;
      var version = document.getElementById("version").value;
