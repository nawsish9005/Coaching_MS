...
$sql_for_gray_variable = "SELECT * FROM defining_calendering_qc_standard WHERE pp_no_id = '$pp_no_id' AND active = '1' ";
...
<div class="x_panel">
  <div class="x_title">
    <h2>Calendering Standards Edit Form</h2>
  ...
  <div class="x_content">
    ...
    <form id="calendering_variable_form" name="calendering_variable_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">n
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="13">
          <input type="hidden" id="calendering_standard_id" name="calendering_standard_id" value="<?php echo $row_for_gray_variable['calendering_standard_id']; ?>">
          <button type="button" name="submit" id="submit" onclick="update_edit_calendering_standard_data('<?php echo $pp_no_id; ?>');" class="btn btn-success" >Update</button>
