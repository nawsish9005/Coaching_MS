...
$sql_for_bleaching_standard = "SELECT * FROM defining_scouring_qc_standard WHERE pp_no_id = '$pp_no_id' AND active = '1' ";
    ...
    <form id="scouring_standard_form" name="scouring_standard_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <button type="button" name="submit" id="submit" onclick="update_edit_scouring_standard_data('<?php echo $pp_no_id; ?>');" class="btn btn-success" >Update</button>
