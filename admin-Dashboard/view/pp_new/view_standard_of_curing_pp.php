          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp = "SELECT 
                                ...
                                defining_curing_qc_standard.*

                             FROM 
                                process_program_info, version_wise_process_program_info, defining_curing_qc_standard   
                             WHERE 
                                process_program_info.pp_id = '$pp_no_id'
                                AND process_program_info.pp_id = pp_details.pp_no_id
                                AND defining_curing_qc_standard.pp_no_id = version_wise_process_program_info.pp_no_id
                                AND defining_curing_qc_standard.pp_details_id = version_wise_process_program_info.pp_id
                                AND defining_curing_qc_standard.active = '1'
