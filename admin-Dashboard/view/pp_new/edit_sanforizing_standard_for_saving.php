<?php 
  ...
  $sanforizing_standard_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['sanforizing_standard_id'])));
  ...
  $update_sql_statement = "UPDATE `defining_sanforizing_qc_standard` 
                    SET `active`= '$previous_active',
                      `lock_or_unlock` = '$previous_lock_or_unlock',
                      `modifying_person_id`= '$edfms_logged_user_id',
                      `modification_time`= NOW()
                  WHERE `sanforizing_standard_id` = '$sanforizing_standard_id'";

   mysqli_query($con, $update_sql_statement) or die(mysqli_error($con));

	 $insert_sql_statement = "INSERT INTO `defining_sanforizing_qc_standard` 
                             ( 
                              `sanforizing_standard_id`,
                              `pp_no_id`, 
                              `pp_details_id`, 
