          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp = "SELECT 
                                ...
                                defining_ready_for_print_qc_standard.*

                             FROM 
                                process_program_info, version_wise_process_program_info, defining_ready_for_print_qc_standard   
                             WHERE 
                                ...
                                AND defining_ready_for_print_qc_standard.pp_no_id = version_wise_process_program_info.pp_no_id
                                AND defining_ready_for_print_qc_standard.pp_details_id = version_wise_process_program_info.pp_id
                                AND defining_ready_for_print_qc_standard.active = '1'
            ...
            <tr>
              ...
              <td>
                <!-- <form action="gray_varibale_edit.php" method="post" style="display: inline-block;"> -->
                  ...
                  <button type="submit" id="ready_for_print_standard_add_btn" name="ready_for_print_standard_add_btn" onclick="edit_for_ready_for_print_standard();" class="btn btn-primary btn-xs"> Edit </button>
                <!-- </form> --> 
              </td>
            </tr>
            <?php 
