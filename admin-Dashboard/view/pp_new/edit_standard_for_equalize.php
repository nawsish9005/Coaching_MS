...
$sql_for_equalize_standard = "SELECT * FROM defining_equalize_qc_standard WHERE pp_no_id = '$pp_no_id' AND pp_details_id = '$pp_details_id' AND active = '1' ";
...
<div class="x_panel">
  <div class="x_title">
    <h2>Equalize Standards Edit Form</h2>
    ...
    <form id="equalize_standard_form" name="equalize_standard_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <button type="button" name="submit" id="submit" onclick="update_edit_equalize_standard_data('<?php echo $pp_details_id; ?>');" class="btn btn-success" >Update</button>
