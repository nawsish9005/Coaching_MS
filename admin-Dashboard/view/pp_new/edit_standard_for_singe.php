...
$sql_for_singe_standard = "SELECT * FROM defining_singeing_desizing_qc_standard WHERE pp_no_id = '$pp_no_id' AND pp_details_id = '$pp_details_id' AND active = '1' ";
  ...
  <div class="x_content">
    ...
    <form id="singe_standard_form" name="singe_standard_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        ...
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="speed">Speed (Meter / Min)<span class="required">*</span>
        </label>
        <div class="col-md-1 col-sm-1 col-xs-2">
