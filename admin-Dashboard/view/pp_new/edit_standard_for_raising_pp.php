...
$sql_for_gray_variable = "SELECT * FROM defining_raising_qc_standard WHERE pp_no_id = '$pp_no_id' AND active = '1' ";
    ...
    <form id="raising_variable_form" name="raising_variable_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <!-- customise for tolarance --> 
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <select id="tensile_warp_cond" name="tensile_warp_cond" onchange="tensile_warp_condition_before();" class="tensile_warp_cond select2 pp_number form-control col-md-12 col-xs-12">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <input type="text" id="tensile_warp_value" name="tensile_warp_value" oninput="tensile_warp_condition_before();" class="tensile_warp_value form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="tensile_warp_cond1" name="tensile_warp_cond1" onchange="tensile_warp_condition_before()" class="tensile_warp_cond1 form-control col-md-12 col-xs-12">
      ...
      <div class="form-group">n
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="15">
          ...
          <button type="button" name="submit" id="submit" onclick="update_edit_raising_standard_data('<?php echo $pp_no_id; ?>');" class="btn btn-success" >Update</button>
