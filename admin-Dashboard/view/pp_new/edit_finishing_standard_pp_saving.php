<?php 
  ...
  $finishing_standard_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['finishing_standard_id'])));
  ...
  $update_sql_statement = "UPDATE `defining_finishing_qc_standard` 
   ...
   { 
       $pp_details_id = $sql_row_for_pp_details['pp_id'];
    	 ...
    	 $insert_sql_statement = "INSERT INTO `defining_finishing_qc_standard` 
                             ( 
