...
if(isset($_POST["action"]))
{
 ...
 if($_POST["action"] == "pp_no_id")
 {
	  ...
	  $query = "SELECT version, pp_no_id, pp_id, color, gray_width FROM version_wise_process_program_info WHERE pp_no_id = '$query_change' AND active = '1'  GROUP BY version";
	  ...
	  while($row = mysqli_fetch_array($result))
	  {
	  	   ...
	  	   $query_for_version = "SELECT version_name FROM version_name WHERE version_id = '$version_select'";
