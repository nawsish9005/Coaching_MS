          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp = "SELECT 
                                ...
                                defining_sanforizing_qc_standard.*

                             FROM 
                                process_program_info, version_wise_process_program_info, defining_sanforizing_qc_standard   
                             WHERE 
                                ...
                                AND defining_sanforizing_qc_standard.pp_no_id = version_wise_process_program_info.pp_no_id
                                AND defining_sanforizing_qc_standard.pp_details_id = version_wise_process_program_info.pp_id
                                AND defining_sanforizing_qc_standard.active = '1'
            ...
            <tr>
             ...
             <td>
                <!-- <form action="gray_varibale_edit.php" method="post" style="display: inline-block;"> -->
                  ...
                  <button type="submit" id="gray_issue_add_btn" name="gray_issue_add_btn" onclick="edit_for_sanforizing_standard();" class="btn btn-primary btn-xs"> Edit </button>
                <!-- </form> -->
              </td>
            </tr>
            <?php 
