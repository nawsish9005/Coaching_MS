...
$sql_for_equalize_standard = "SELECT * FROM defining_equalize_qc_standard WHERE pp_no_id = '$pp_no_id' AND active = '1' ";
$res_for_equalize_standard = mysqli_query($con , $sql_for_equalize_standard);
$row_for_equalize_standard = mysqli_fetch_array($res_for_equalize_standard);
?>
    ...
    <form id="equalize_standard_form" name="equalize_standard_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-1 col-sm-1 col-xs-2">
          <select id="whiteness_cond1" name="whiteness_cond1" onchange="whiteness_condition()" class="whiteness_cond1 form-control col-md-12 col-xs-12">
            ...
            <option <?php if($row_for_equalize_standard['whiteness_cond1'] == 1) {echo "selected";} ?> value="1">(</option>
            <option <?php if($row_for_equalize_standard['whiteness_cond1'] == 2) {echo "selected";} ?>  value="2">[</option>
          </select>
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2">
          <input type="text" id="whiteness_value1" value="<?php echo $row_for_equalize_standard['whiteness_value1']; ?>" name="whiteness_value1" class="whiteness_value1 form-control col-md-7 col-xs-12">
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
          --
        </div> 
        <div class="col-md-1 col-sm-1 col-xs-2">
          <input type="text" id="whiteness_value2" value="<?php echo $row_for_equalize_standard['whiteness_value2']; ?>" name="whiteness_value2" class="whiteness_value2 form-control col-md-7 col-xs-12">
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2">
          <select id="whiteness_cond2" name="whiteness_cond2" class="whiteness_cond2 form-control col-md-12 col-xs-12">
            <option value="">Select Condition</option>
            <option <?php if($row_for_equalize_standard['whiteness_cond2'] == 1) {echo "selected";} ?> value="1">)</option>
            <option <?php if($row_for_equalize_standard['whiteness_cond2'] == 2) {echo "selected";} ?> value="2">]</option>
          </select>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-1 col-sm-1 col-xs-2">
          <select id="bowing_and_skew_cond1" name="bowing_and_skew_cond1" onchange="bowing_and_skew_condition()" class="bowing_and_skew_cond1 form-control col-md-12 col-xs-12">
            <option value="">Select Condition</option>
            <option <?php if($row_for_equalize_standard['bowing_and_skew_cond1'] == 1) {echo "selected";} ?> value="1">(</option>
            <option <?php if($row_for_equalize_standard['bowing_and_skew_cond1'] == 2) {echo "selected";} ?> value="2">[</option>
          </select>
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2">
          <input type="text" id="bowing_and_skew_value1" value="<?php echo $row_for_equalize_standard['bowing_and_skew_value1']; ?>" name="bowing_and_skew_value1" class="bowing_and_skew_value1 form-control col-md-7 col-xs-12">
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
          --
        </div> 
        <div class="col-md-1 col-sm-1 col-xs-2">
          <input type="text" id="bowing_and_skew_value2" value="<?php echo $row_for_equalize_standard['bowing_and_skew_value2']; ?>" name="bowing_and_skew_value2" class="bowing_and_skew_value2 form-control col-md-7 col-xs-12">
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2">
          <select id="bowing_and_skew_cond2" name="bowing_and_skew_cond2" class="bowing_and_skew_cond2 form-control col-md-12 col-xs-12">
            <option value="">Select Condition</option>
            <option <?php if($row_for_equalize_standard['bowing_and_skew_cond2'] == 1) {echo "selected";} ?> value="1">)</option>
            <option <?php if($row_for_equalize_standard['bowing_and_skew_cond2'] == 2) {echo "selected";} ?> value="2">]</option>
          </select>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-1 col-sm-1 col-xs-2">
          <select id="ph_cond1" name="ph_cond1" onchange="ph_condition()" class="ph_cond1 form-control col-md-12 col-xs-12">
            <option value="">Select Condition</option>
            <option <?php if($row_for_equalize_standard['ph_cond1'] == 1) {echo "selected";} ?> value="1">(</option>
            <option <?php if($row_for_equalize_standard['ph_cond1'] == 2) {echo "selected";} ?> value="2">[</option>
          </select>
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2">
          <input type="text" id="ph_value1" value="<?php echo $row_for_equalize_standard['ph_value1']; ?>" name="ph_value1" class="ph_value1 form-control col-md-7 col-xs-12">
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
          --
        </div> 
        <div class="col-md-1 col-sm-1 col-xs-2">
          <input type="text" id="ph_value2" value="<?php echo $row_for_equalize_standard['ph_value2']; ?>" name="ph_value2" class="ph_value2 form-control col-md-7 col-xs-12">
        </div>
        <div class="col-md-1 col-sm-1 col-xs-2">
          <select id="ph_cond2" name="ph_cond2" class="ph_cond2 form-control col-md-12 col-xs-12">
            <option value="">Select Condition</option>
            <option <?php if($row_for_equalize_standard['ph_cond2'] == 1) {echo "selected";} ?> value="1">)</option>
            <option <?php if($row_for_equalize_standard['ph_cond2'] == 2) {echo "selected";} ?> value="2">]</option>
          </select>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="6">
          <input type="hidden" id="equalize_standard_id" name="equalize_standard_id" value="<?php echo $row_for_equalize_standard['equalize_standard_id']; ?>">
          <button type="button" name="submit" id="submit" onclick="update_edit_equalize_standard_data('<?php echo $pp_no_id; ?>');" class="btn btn-success" >Update</button>
          <button type="button" name="submit" id="submit" onclick="cancel_edit_equalize_standard_data();" class="btn btn-success" >Cancel</button>
        </div>
      </div>
