<?php 
  ...
  $update_sql_statement = "UPDATE `defining_scouring_bleaching_qc_standard` 
   ...
   { 
      ...
      //chcek last insert id
       $sql = 'SELECT id
                FROM defining_scouring_bleaching_qc_standard ORDER BY id DESC LIMIT 1';
       $sql_res = mysqli_query($con, $sql) or die(mysqli_error($con));
       $sql_row = mysqli_fetch_assoc($sql_res);
       $scouring_bleaching_standard_id = $sql_row['id'] + 1;

      	$insert_sql_statement = "INSERT INTO `defining_scouring_bleaching_qc_standard` 
                                   ( 
