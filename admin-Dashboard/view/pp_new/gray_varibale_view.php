                                  ...
                                  <?php 
                                    ...
                                    $sql_for_pp = "SELECT 
                                                   ...
                                                   WHERE 
                                                      ...
                                                      AND version_wise_process_program_info.id = '$pp_details_id'
                                                      AND defining_gray_receiving_qc_standard.pp_no_id = version_wise_process_program_info.pp_no_id
                                                      AND defining_gray_receiving_qc_standard.pp_details_id = version_wise_process_program_info.id
