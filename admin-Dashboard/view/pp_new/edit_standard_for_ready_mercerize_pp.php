...
$sql_for_ready_mercerize_standard = "SELECT * FROM defining_ready_mercerize_qc_standard WHERE pp_no_id = '$pp_no_id' AND active = '1' ";
...
<div class="x_panel">
  <div class="x_title">
    <h2>Ready Mercerize Standards Edit Form</h2>
    ...
    <form id="ready_mercerize_standard_form" name="ready_mercerize_standard_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <button type="button" name="submit" id="submit" onclick="update_edit_ready_mercerize_standard_data('<?php echo $pp_no_id; ?>');" class="btn btn-success" >Update</button>
