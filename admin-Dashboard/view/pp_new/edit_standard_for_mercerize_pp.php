...
$sql_for_mercerize_standard = "SELECT * FROM defining_mercerize_qc_standard WHERE pp_no_id = '$pp_no_id' AND active = '1' ";
    ...
    <form id="mercerize_standard_form" name="mercerize_standard_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="5">
          ...
          <button type="button" name="submit" id="submit" onclick="update_edit_mercerize_standard_data('<?php echo $pp_no_id; ?>');" class="btn btn-success" >Update</button>
