...
$sql_for_scouring_bleaching_standard = "SELECT * FROM defining_scouring_bleaching_qc_standard WHERE pp_no_id = '$pp_no_id' AND pp_details_id = '$pp_details_id' AND active = '1' ";
$res_for_scouring_bleaching_standard = mysqli_query($con , $sql_for_scouring_bleaching_standard);
$row_for_bleaching_standard = mysqli_fetch_array($res_for_scouring_bleaching_standard);
?>


<div class="x_panel">
  <div class="x_title">
    <h2>Scouring & Bleaching Standards Edit Form</h2>
  ...
  <div class="x_content">
    ...
    <form id="scouring_bleaching_standard_form" name="scouring_bleaching_standard_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="pilling_cond1" name="pilling_cond1" onchange="pilling_condition()" class="pilling_cond1 form-control col-md-12 col-xs-12">
                ...
                <option value="1" <?php echo ($row_for_bleaching_standard['pilling_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_bleaching_standard['pilling_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="pilling_value1" name="pilling_value1" value="<?php echo isset($row_for_bleaching_standard['pilling_value1']) ? $row_for_bleaching_standard['pilling_value1'] : "" ?>" class="pilling_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="pilling_value2" name="pilling_value2" value="<?php echo isset($row_for_bleaching_standard['pilling_value2']) ? $row_for_bleaching_standard['pilling_value2'] : "" ?>" class="pilling_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="pilling_cond2" name="pilling_cond2" class="pilling_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_bleaching_standard['pilling_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_bleaching_standard['pilling_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <input type="hidden" id="scouring_bleaching_standard_id" name="scouring_bleaching_standard_id" value="<?php echo $row_for_bleaching_standard['scouring_bleaching_standard_id']; ?>">
          <button type="button" name="submit" id="submit" onclick="update_edit_scouring_bleaching_standard_data('<?php echo $pp_details_id; ?>');" class="btn btn-success" >Update</button>
          <button type="button" name="submit" id="submit" onclick="cancel_edit_scouring_bleaching_standard_data();" class="btn btn-success" >Cancel</button>
        </div>
      </div>
