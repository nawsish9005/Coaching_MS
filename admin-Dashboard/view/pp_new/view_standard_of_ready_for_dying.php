          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp =  "SELECT 
                                ...
                                defining_ready_for_dying_qc_standard.*

                             FROM 
                                process_program_info, version_wise_process_program_info, defining_ready_for_dying_qc_standard   
                             WHERE 
                                ...
                                AND defining_ready_for_dying_qc_standard.pp_no_id = version_wise_process_program_info.pp_no_id
                                AND defining_ready_for_dying_qc_standard.pp_details_id = version_wise_process_program_info.pp_id
                                AND defining_ready_for_dying_qc_standard.active = '1'
