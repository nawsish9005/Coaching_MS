          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp = "SELECT 
                                ...
                                defining_finishing_qc_standard.*

                             FROM 
                                process_program_info, version_wise_process_program_info, defining_finishing_qc_standard   
                             WHERE 
                                process_program_info.pp_id = '$pp_no_id'
                                AND process_program_info.pp_id = version_wise_process_program_info.pp_no_id
                                AND defining_finishing_qc_standard.pp_no_id = version_wise_process_program_info.pp_no_id
                                AND defining_finishing_qc_standard.pp_details_id = version_wise_process_program_info.pp_id
                                AND defining_finishing_qc_standard.active = '1'
            ...
            <?php 
              ...
              $sql_for_pp = "SELECT 
                             ...
                             WHERE 
                                ...
                                AND defining_finishing_qc_standard.pp_no_id = version_wise_process_program_info.pp_no_id
                                AND defining_finishing_qc_standard.version_wise_process_program_info_id = version_wise_process_program_info.pp_id
                                AND defining_finishing_qc_standard.active = '1'
                                AND version_wise_process_program_info.active = '1'
                             ";
