...
$sql_for_gray_variable = "SELECT * FROM defining_finishing_qc_standard WHERE pp_no_id = '$pp_no_id' AND active = '1' ";
...
<div class="x_panel">
  <div class="x_title">
    <h2>Finishing Standards Edit Form</h2>
    ...
    <form id="gray_variable_form" name="gray_variable_form" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <!-- customise for tolarance --> 
          ...
          <!-- <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="number_thread_warp_tol_value" name="number_thread_warp_tol_value" oninput="number_thread_warp_tol();" class="number_thread_warp_tol_value1 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <input type="text" id="number_thread_warp_tol_positive" placeholder="For +" name="number_thread_warp_tol_positive" oninput="number_thread_warp_tol();" class="number_thread_warp_tol_positive form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="number_thread_warp_tol_negative" placeholder="For -" name="number_thread_warp_tol_negative" oninput="number_thread_warp_tol();" class="number_thread_warp_tol_negative form-control col-md-7 col-xs-12">
            </div>
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="number_thread_warp_cond1" name="number_thread_warp_cond1" onchange="number_thread_warp_condition()" class="number_thread_warp_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['number_thread_warp_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['number_thread_warp_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="number_thread_weft_tol_value" name="number_thread_weft_tol_value" oninput="number_thread_weft_tol();" class="number_thread_weft_tol_value1 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <input type="text" id="number_thread_weft_tol_positive" placeholder="For +" name="number_thread_weft_tol_positive" oninput="number_thread_weft_tol();" class="number_thread_weft_tol_positive form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="number_thread_weft_tol_negative" placeholder="For -" name="number_thread_weft_tol_negative" oninput="number_thread_weft_tol();" class="number_thread_weft_tol_negative form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <select id="number_thread_weft_unit" name="number_thread_weft_unit" class="number_thread_weft_unit form-control col-md-12 col-xs-12">
                <option value="th/inch" selected <?php echo ($row_for_gray_variable['number_thread_weft_unit'] == 'th/inch') ? 'selected' : '' ?> >th/inch</option>
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="number_thread_weft_cond1" name="number_thread_weft_cond1" onchange="number_thread_weft_condition()" class="number_thread_weft_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['number_thread_weft_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['number_thread_weft_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="abrasion_resistance_cond1" name="abrasion_resistance_cond1" onchange="abrasion_resistance_condition()" class="abrasion_resistance_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['abrasion_resistance_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['abrasion_resistance_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="abrasion_resistance_value1" name="abrasion_resistance_value1" value="<?php echo isset($row_for_gray_variable['abrasion_resistance_value1']) ? $row_for_gray_variable['abrasion_resistance_value1'] : "" ?>" class="abrasion_resistance_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="abrasion_resistance_value2" name="abrasion_resistance_value2" value="<?php echo isset($row_for_gray_variable['abrasion_resistance_value2']) ? $row_for_gray_variable['abrasion_resistance_value2'] : "" ?>" class="abrasion_resistance_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="abrasion_resistance_cond2" name="abrasion_resistance_cond2" class="abrasion_resistance_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['abrasion_resistance_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['abrasion_resistance_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
              <input type="text" id="abrasion_resistance_thread_break" name="abrasion_resistance_thread_break" value="<?php echo isset($row_for_gray_variable['abrasion_resistance_thread_break']) ? $row_for_gray_variable['abrasion_resistance_thread_break'] : "" ?>" class="abrasion_resistance_thread_break form-control col-md-7 col-xs-12">
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
              <input type="text" id="revolution" name="revolution" placeholder="Shade change , Thread Break" value="<?php echo isset($row_for_gray_variable['revolution']) ? $row_for_gray_variable['revolution'] : "" ?>" class="revolution form-control col-md-7 col-xs-12">
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6" style='text-align: center;'>
              <select id="print_durability" name="print_durability" class="print_durability form-control col-md-12 col-xs-12">
                <option value="No" selected <?php echo ($row_for_gray_variable['print_durability'] == 'No') ? 'selected' : '' ?> >No</option>
                <option value="Negligible" <?php echo ($row_for_gray_variable['print_durability'] == 'Negligible') ? 'selected' : '' ?> >Negligible</option>
                <option value="Slight" <?php echo ($row_for_gray_variable['print_durability'] == 'Slight') ? 'selected' : '' ?> >Slight</option>
                <option value="Distinct/Complete" <?php echo ($row_for_gray_variable['print_durability'] == 'Distinct/Complete') ? 'selected' : '' ?> >Distinct/Complete</option>
              </select>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <input type="text" id="abrasion_resistance_lose_value" name="abrasion_resistance_lose_value" oninput="abrasion_resistance_lose_condition();" value="<?php echo isset($row_for_gray_variable['abrasion_resistance_lose_value']) ? $row_for_gray_variable['abrasion_resistance_lose_value'] : "" ?>" class="abrasion_resistance_lose_value form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="hidden"   class="form-control col-md-7 col-xs-12">
            </div>
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="abrasion_resistance_lose_cond1" name="abrasion_resistance_lose_cond1" onchange="abrasion_resistance_lose_condition()" class="abrasion_resistance_lose_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['abrasion_resistance_lose_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['abrasion_resistance_lose_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="abrasion_resistance_lose_value1" name="abrasion_resistance_lose_value1" value="<?php echo isset($row_for_gray_variable['abrasion_resistance_lose_value1']) ? $row_for_gray_variable['abrasion_resistance_lose_value1'] : "" ?>" class="abrasion_resistance_lose_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="abrasion_resistance_lose_value2" name="abrasion_resistance_lose_value2" value="<?php echo isset($row_for_gray_variable['abrasion_resistance_lose_value2']) ? $row_for_gray_variable['abrasion_resistance_lose_value2'] : "" ?>" class="abrasion_resistance_lose_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="abrasion_resistance_lose_cond2" name="abrasion_resistance_lose_cond2" class="abrasion_resistance_lose_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['abrasion_resistance_lose_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['abrasion_resistance_lose_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <select id="formaldehyde_content_unit" name="formaldehyde_content_unit" class="formaldehyde_content_unit form-control col-md-12 col-xs-12">
                <option value="PPM" selected <?php echo ($row_for_gray_variable['formaldehyde_content_unit'] == 'PPM') ? 'selected' : '' ?> >PPM</option>
                <option value="mg/kg" <?php echo ($row_for_gray_variable['formaldehyde_content_unit'] == 'mg/kg') ? 'selected' : '' ?> >mg/kg</option>
              </select>
            </div>
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="formaldehyde_content_cond1" name="formaldehyde_content_cond1" onchange="formaldehyde_content_condition()" class="formaldehyde_content_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['formaldehyde_content_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['formaldehyde_content_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="formaldehyde_content_value1" name="formaldehyde_content_value1" value="<?php echo isset($row_for_gray_variable['formaldehyde_content_value1']) ? $row_for_gray_variable['formaldehyde_content_value1'] : "" ?>" class="formaldehyde_content_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="formaldehyde_content_value2" name="formaldehyde_content_value2" value="<?php echo isset($row_for_gray_variable['formaldehyde_content_value2']) ? $row_for_gray_variable['formaldehyde_content_value2'] : "" ?>" class="formaldehyde_content_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="formaldehyde_content_cond2" name="formaldehyde_content_cond2" class="formaldehyde_content_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['formaldehyde_content_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['formaldehyde_content_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="cf_artificial_light_c_change_cond1" name="cf_artificial_light_c_change_cond1" onchange="cf_artificial_light_c_change_condition()" class="cf_artificial_light_c_change_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['cf_artificial_light_c_change_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['cf_artificial_light_c_change_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="cf_artificial_light_c_change_value1" name="cf_artificial_light_c_change_value1" value="<?php echo isset($row_for_gray_variable['cf_artificial_light_c_change_value1']) ? $row_for_gray_variable['cf_artificial_light_c_change_value1'] : "" ?>" class="cf_artificial_light_c_change_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="cf_artificial_light_c_change_value2" name="cf_artificial_light_c_change_value2" value="<?php echo isset($row_for_gray_variable['cf_artificial_light_c_change_value2']) ? $row_for_gray_variable['cf_artificial_light_c_change_value2'] : "" ?>" class="cf_artificial_light_c_change_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="cf_artificial_light_c_change_cond2" name="cf_artificial_light_c_change_cond2" class="cf_artificial_light_c_change_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['cf_artificial_light_c_change_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['cf_artificial_light_c_change_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div> -->
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <select id="water_absorption_unit" name="water_absorption_unit" class="water_absorption_unit form-control col-md-12 col-xs-12">
                <option value="Sec" selected <?php echo ($row_for_gray_variable['water_absorption_unit'] == 'Sec') ? 'selected' : '' ?> >Sec</option>
                <option value="mm" <?php echo ($row_for_gray_variable['water_absorption_unit'] == 'mm') ? 'selected' : '' ?> >mm</option>
                <option value="%" <?php echo ($row_for_gray_variable['water_absorption_unit'] == '%') ? 'selected' : '' ?> >%</option>
              </select>
            </div>
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="water_absorption_cond1" name="water_absorption_cond1" onchange="water_absorption_tol_condition()" class="water_absorption_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['water_absorption_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['water_absorption_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="water_absorption_value1" name="water_absorption_value1" value="<?php echo isset($row_for_gray_variable['water_absorption_value1']) ? $row_for_gray_variable['water_absorption_value1'] : "" ?>" class="water_absorption_value1 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="water_absorption_value2" name="water_absorption_value2" value="<?php echo isset($row_for_gray_variable['water_absorption_value2']) ? $row_for_gray_variable['water_absorption_value2'] : "" ?>" class="water_absorption_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="water_absorption_cond2" name="water_absorption_cond2" class="water_absorption_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['water_absorption_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['water_absorption_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <input type="text" id="spirality_value" name="spirality_value" oninput="spirality_condition();" value="<?php echo isset($row_for_gray_variable['spirality_value']) ? $row_for_gray_variable['spirality_value'] : "" ?>" class="spirality_value form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="hidden"   class="form-control col-md-7 col-xs-12">
            </div>
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="spirality_cond1" name="spirality_cond1" onchange="spirality_condition()" class="spirality_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['spirality_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['spirality_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="spirality_value1" name="spirality_value1" value="<?php echo isset($row_for_gray_variable['spirality_value1']) ? $row_for_gray_variable['spirality_value1'] : "" ?>" class="spirality_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="spirality_value2" name="spirality_value2" value="<?php echo isset($row_for_gray_variable['spirality_value2']) ? $row_for_gray_variable['spirality_value2'] : "" ?>" class="spirality_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="spirality_cond2" name="spirality_cond2" class="spirality_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['spirality_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['spirality_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="durable_press_cond1" name="durable_press_cond1" onchange="durable_press_condition()" class="durable_press_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['durable_press_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['durable_press_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="durable_press_value1" name="durable_press_value1" value="<?php echo isset($row_for_gray_variable['durable_press_value1']) ? $row_for_gray_variable['durable_press_value1'] : "" ?>" class="durable_press_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="durable_press_value2" name="durable_press_value2" value="<?php echo isset($row_for_gray_variable['durable_press_value2']) ? $row_for_gray_variable['durable_press_value2'] : "" ?>" class="durable_press_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="durable_press_cond2" name="durable_press_cond2" class="durable_press_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['durable_press_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['durable_press_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="ironability_cond1" name="ironability_cond1" onchange="ironability_condition()" class="ironability_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['ironability_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['ironability_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="ironability_value1" name="ironability_value1" value="<?php echo isset($row_for_gray_variable['ironability_value1']) ? $row_for_gray_variable['ironability_value1'] : "" ?>" class="ironability_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="ironability_value2" name="ironability_value2" value="<?php echo isset($row_for_gray_variable['ironability_value2']) ? $row_for_gray_variable['ironability_value2'] : "" ?>" class="ironability_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="ironability_cond2" name="ironability_cond2" class="ironability_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['ironability_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['ironability_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="cf_artificial_light_cond1" name="cf_artificial_light_cond1" onchange="cf_artificial_light_condition()" class="cf_artificial_light_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['cf_artificial_light_cond1'] == '1') ? 'selected' : '' ?> >(</option>
                <option value="2" <?php echo ($row_for_gray_variable['cf_artificial_light_cond1'] == '2') ? 'selected' : '' ?> >[</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="cf_artificial_light_value1" name="cf_artificial_light_value1" value="<?php echo isset($row_for_gray_variable['cf_artificial_light_value1']) ? $row_for_gray_variable['cf_artificial_light_value1'] : "" ?>" class="cf_artificial_light_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="cf_artificial_light_value2" name="cf_artificial_light_value2" value="<?php echo isset($row_for_gray_variable['cf_artificial_light_value2']) ? $row_for_gray_variable['cf_artificial_light_value2'] : "" ?>" class="cf_artificial_light_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="cf_artificial_light_cond2" name="cf_artificial_light_cond2" class="cf_artificial_light_cond2 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
                <option value="1" <?php echo ($row_for_gray_variable['cf_artificial_light_cond2'] == '1') ? 'selected' : '' ?> >)</option>
                <option value="2" <?php echo ($row_for_gray_variable['cf_artificial_light_cond2'] == '2') ? 'selected' : '' ?> >]</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="moisture_content_cond1" name="moisture_content_cond1" onchange="moisture_content_condition()" class="cf_rubbing_wet_cond1 form-control col-md-12 col-xs-12">
                <option value="2" selected="selected" <?php echo ($row_for_gray_variable['moisture_content_cond1'] == '2') ? 'selected' : '' ?> >[</option>
                <option value="1" <?php echo ($row_for_gray_variable['moisture_content_cond1'] == '1') ? 'selected' : '' ?> >(</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="moisture_content_value1" name="moisture_content_value1" value="<?php echo isset($row_for_gray_variable['moisture_content_value1']) ? $row_for_gray_variable['moisture_content_value1'] : "" ?>" class="moisture_content_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="moisture_content_value2" name="moisture_content_value2" value="<?php echo isset($row_for_gray_variable['moisture_content_value2']) ? $row_for_gray_variable['moisture_content_value2'] : "" ?>" class="moisture_content_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="moisture_content_cond2" name="moisture_content_cond2" class="moisture_content_cond2 form-control col-md-12 col-xs-12">
                <option value="2" selected="selected" <?php echo ($row_for_gray_variable['moisture_content_cond2'] == '2') ? 'selected' : '' ?> >]</option>
                <option value="1" <?php echo ($row_for_gray_variable['moisture_content_cond2'] == '1') ? 'selected' : '' ?> >)</option>
              </select>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="evaporation_rate_cond1" name="evaporation_rate_cond1" onchange="evaporation_rate_condition()" class="cf_rubbing_wet_cond1 form-control col-md-12 col-xs-12">
                <option value="2" selected="selected" <?php echo ($row_for_gray_variable['evaporation_rate_cond1'] == '2') ? 'selected' : '' ?> >[</option>
                <option value="1" <?php echo ($row_for_gray_variable['evaporation_rate_cond1'] == '1') ? 'selected' : '' ?> >(</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="evaporation_rate_value1" name="evaporation_rate_value1" value="<?php echo isset($row_for_gray_variable['evaporation_rate_value1']) ? $row_for_gray_variable['evaporation_rate_value1'] : "" ?>" class="evaporation_rate_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="evaporation_rate_value2" name="evaporation_rate_value2" value="<?php echo isset($row_for_gray_variable['evaporation_rate_value2']) ? $row_for_gray_variable['evaporation_rate_value2'] : "" ?>" class="evaporation_rate_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="evaporation_rate_cond2" name="evaporation_rate_cond2" class="evaporation_rate_cond2 form-control col-md-12 col-xs-12">
                <option value="2" selected="selected" <?php echo ($row_for_gray_variable['evaporation_rate_cond2'] == '2') ? 'selected' : '' ?> >]</option>
                <option value="1" <?php echo ($row_for_gray_variable['evaporation_rate_cond2'] == '1') ? 'selected' : '' ?> >)</option>
              </select>
            </div>
      ...
      <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
          ...
          <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="9">
          <input type="hidden" id="finishing_standard_id" name="finishing_standard_id" value="<?php echo $row_for_gray_variable['finishing_standard_id']; ?>">
          <button type="button" name="submit" id="submit" onclick="update_edit_finishing_standard_data('<?php echo $pp_no_id; ?>');" class="btn btn-success" >Update</button>
