...
$sql_for_ready_mercerize_standard = "SELECT * FROM defining_ready_mercerize_qc_standard WHERE pp_no_id = '$pp_no_id' AND pp_details_id = '$pp_details_id' AND active = '1' ";
