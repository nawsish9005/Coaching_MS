<?php 
	...
	$equalize_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['equalize_id'])));
	...
	$insert_pp_details_statement = "UPDATE `equalize` 
								    SET `date`= '$date',
								   		`b_batcher`= '$b_batcher',
								   		`a_batcher`= '$a_batcher',
								   		`p_width`= '$p_width',
								  ...
								  WHERE `route_issue_id` = '$route_issue_id' AND equalize_id = '$equalize_id' ";
