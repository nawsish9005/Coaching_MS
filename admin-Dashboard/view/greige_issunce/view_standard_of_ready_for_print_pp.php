          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp = "SELECT 
                                ...
                                pp_details.quantity,
                                ready_for_print_standard.*

                             FROM 
                                pp, pp_details, ready_for_print_standard   
                             WHERE 
                                pp.pp_id = '$pp_no_id'
                                AND pp.pp_id = pp_details.pp_no_id
                                AND ready_for_print_standard.pp_no_id = pp_details.pp_no_id
                                AND ready_for_print_standard.pp_details_id = pp_details.pp_id
                                AND ready_for_print_standard.active = '1'
