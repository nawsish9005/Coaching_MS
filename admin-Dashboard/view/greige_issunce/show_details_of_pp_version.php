                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                  ...
                                  <button type="button" id="gray_issue_add_btn" value="<?php echo $sl; ?>" name="gray_issue_add_btn" onclick="view_standard_select(this.value);" class="btn btn-primary btn-xs"> View/Add Greige Receiving </button>
                              </td>                       
                            </tr>
                          </tbody>
                      <?php
