...
if(isset($_POST["action"]))
{
 ...
 {	
	  ...
	  $query = "SELECT * FROM process_name_define WHERE pp_no_id = '$pp_no_id' AND pp_details_id = '$query_change' AND active = '1'";
	  ...
	  while($row = mysqli_fetch_array($result))
	  {
	  	   ...
	  	   $query_for_route = "SELECT * FROM process_name WHERE process_id = '$route_select'";
	       ...
	       $output .= '<option value="'.$manual_route.'">'.$row_for_route["process_name"].'</option>';
