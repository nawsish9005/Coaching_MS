      ...
      <div class="x_content">
        ...
        <form id="finishing_variable_form" name="finishing_variable_form" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="cross_staining_cond1" name="cross_staining_cond1" class="cross_staining_cond1 form-control col-md-12 col-xs-12">
                <option value="" selected="selected">Select Condition</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <input type="text" id="water_absorption_value" name="water_absorption_value" onchange="water_absorption_condition();"  class="water_absorption_value form-control col-md-7 col-xs-12">
            </div> 
            ...
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              <select id="water_absorption_unit" name="water_absorption_unit" onchange="water_absorption_condition();" class="water_absorption_unit form-control col-md-12 col-xs-12">
