<?php 
	...
	if (($date == '') || (empty($date)) || ($greige_demand == '') 
		...
		|| is_null($customer) || ($process == '') || (empty($process))
		|| is_null($process)) 
	{
					...
					$insert_sql_statement = "UPDATE `pp` 
								    SET `issue_date`= '$date',
								        `pp_desc`= '$pp_desc',
								   		...
								   		`fiber_cotton`= '$fiber_cotton',
								   		`fiber_polyster`= '$fiber_polyster',
								   		`fiber_others_name`= '$fiber_others_name',
								   		`fiber_others_value`= '$fiber_others_value',
								   		`week`= '$week',
								   		`design`= '$design',
								   		`process`= '$process',
