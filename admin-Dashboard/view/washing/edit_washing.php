                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <?php
                          ...
                          $row_bleaching = mysqli_fetch_assoc($res_for_washing);
                        ?>
                        <form id="washing_form" name="washing_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="machine_temp" name="machine_temp" value="<?php echo $row_bleaching['machine_temp'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              formdata.append("washing_id", <?php echo $washing_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_washing_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
