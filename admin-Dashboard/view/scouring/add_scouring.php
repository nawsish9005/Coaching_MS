                        ...
                        <form id="scouring_form" name="scouring_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="absorbency_left" name="absorbency_left" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="absorbency_center" name="absorbency_center" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="absorbency_right" name="absorbency_right" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="size_left" name="size_left" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="size_center" name="size_center" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="size_right" name="size_right" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="pilling" name="pilling" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              $.ajax({
              type: "POST",
              url: "add_scouring_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
