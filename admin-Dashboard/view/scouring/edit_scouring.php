...
if (($greige_issunce_id == '') || (empty($greige_issunce_id)) || is_null($greige_issunce_id)||
  ($route_issue_id == '') || (empty($route_issue_id)) || is_null($route_issue_id)) {
   header("Location: scouring_list.php");
}
?>
                        ...
                        <form id="scouring_form" name="scouring_form" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <div class='input-group date' id='myDatepicker2'>
                                <input type='text' class="form-control" id="custom_date" name="custom_date" value="<?php echo $row_scouring['date']; ?>"/>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="b_batcher" name="b_batcher" value="<?php echo $row_scouring['b_batcher']; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="a_batcher" name="a_batcher" value="<?php echo $row_scouring['a_batcher']; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="p_width" name="p_width" value="<?php echo $row_scouring['p_width'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="p_qty" name="p_qty" value="<?php echo $row_scouring['p_qty'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="s_or_e" name="s_or_e" value="<?php echo $row_scouring['s_or_e'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="absorbency_left" name="absorbency_left" value="<?php echo $row_scouring['absorbency_left'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="absorbency_center" name="absorbency_center" value="<?php echo $row_scouring['absorbency_center'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="absorbency_right" name="absorbency_right" value="<?php echo $row_scouring['absorbency_right'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="size_left" name="size_left" value="<?php echo $row_scouring['size_left'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="size_center" name="size_center" value="<?php echo $row_scouring['size_center'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="size_right" name="size_right" value="<?php echo $row_scouring['size_right'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="pilling" name="pilling" value="<?php echo $row_scouring['pilling'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          ...
                          <div class="form-group text-center">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Left</span>
                              <input type="text" id="ph_left" name="ph_left" value="<?php echo $row_scouring['ph_left'];?>" class="form-control col-md-7 col-xs-12">
                              <input type="hidden" id="route_issue_id" name="route_issue_id" value="<?php echo $route_issue_id; ?>">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Center</span>
                              <input type="text" id="ph_center" name="ph_center" value="<?php echo $row_scouring['ph_center'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-4">
                              <span>Right</span>
                              <input type="text" id="ph_right" name="ph_right" value="<?php echo $row_scouring['ph_right'];?>" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
    ...
    <script type="text/javascript">
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          {
              var formdata = new FormData(document.getElementById('scouring_form'));
              formdata.append("route_issue_id", <?php echo $route_issue_id; ?> );
              formdata.append("scouring_id", <?php echo $scouring_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_scouring_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_scouring.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
