...
function add_new_greige_issunce()
{
    ...
    if(document.getElementsByClassName("composition")[0].value == "")
    {
        missing_alert_for_class("composition", 0);
        return false;
    }
    else
    {
        ...
        $.ajax({
        type: "POST",
        url: "greige_issunce_saving.php",// where you wanna post
        data: formdata,
        processData: false,
        contentType: false,
