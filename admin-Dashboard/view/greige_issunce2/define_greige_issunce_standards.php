          ...
          <tbody>
            <?php
              $sql_for_pp = "SELECT
                             ...
                             LEFT JOIN greige_issunce AS gis
            ...
            <tr>
              ...
              <td>
                ...
                <?php
                  ...
                  $sql_for_gray_variable_check = "SELECT * FROM gray_variable WHERE pp_no_id = '$pp_no_id' AND pp_details_id = '$pp_details_id' AND active = '1' ";
                  ...
                  if ($row_for_gray_variable_check >= 1)
                  {
                    ?>
                      <!-- <form action="add_greige_issunce.php" method="post" style="display: inline;"> -->
                        ...
                        <button type="submit" id="gray_issue_add_btn" onclick="greige_issunce_add();" name="gray_issue_add_btn" class="btn btn-primary btn-xs">Greige Issunce Add</button>
                      <!-- </form> -->
                    <?php
                  }
                ?>
