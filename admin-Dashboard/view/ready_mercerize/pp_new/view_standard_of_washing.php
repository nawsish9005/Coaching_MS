          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp = "SELECT 
                             ...
                             FROM 
                                pp, pp_details, washing_standard   
                             WHERE 
                                pp.pp_id = '$pp_no_id'
                                AND pp.pp_id = pp_details.pp_no_id
                                AND pp_details.pp_id = '$pp_version'
                                AND washing_standard.pp_no_id = pp_details.pp_no_id
                                AND washing_standard.pp_details_id = pp_details.pp_id
                                AND washing_standard.active = '1'
            ...
            <tr>
              ...
              <td>
                <!-- <form action="gray_varibale_edit.php" method="post" style="display: inline-block;"> -->
                  ...
                  <button type="submit" id="gray_issue_add_btn" name="gray_issue_add_btn" onclick="edit_for_washing_standard(<?php echo $pp_version ?>);" class="btn btn-primary btn-xs"> Edit </button>
                <!-- </form> -->
              </td>
            </tr>
            <?php 
