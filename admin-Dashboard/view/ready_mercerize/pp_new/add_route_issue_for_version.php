...
<div class="x_panel">
  <div class="x_title">
    <h2>Process Route Selection form</h2>
  ...
  <div class="x_content">
    <div class="col-md-12 center-margin">
      <form id="route_selected_form" name="route_selected_form" data-parsley-validate class="form-horizontal form-label-left">
        ...
        <br>
            <div class="full_row col-md-12 col-sm-12 col-xs-12" >
              <div class="col-md-5 col-sm-5 col-xs-6">
                <label class="control-label">Process Name 
                </label>
              </div>

              <div class="col-md-4 col-sm-4 col-xs-6">
                <label class="control-label">Process/Reprocess 
                </label>
              </div>

              <div class="col-md-2 col-sm-2 col-xs-2">
                <label class="control-label">Process Serial  
                </label>
              </div>
            </div>
        ...
        <div class="full_row col-md-12 col-sm-12 col-xs-12" >
            <div class="col-md-5 col-sm-5 col-xs-6">
              <select disabled class="version-route select2 form-control col-md-12 col-xs-12">
                  <option  selected="selected">Greige Receive</option>
              </select>
            </div>

            <div class="col-md-4 col-sm-4 col-xs-6">
              <select disabled class="version-route select2 form-control col-md-12 col-xs-12">
                  <option  selected="selected">Mandatory</option>
              </select>
            </div>

            <div class="col-md-2 col-sm-2 col-xs-2">
                <input readonly value="1" class="version-number date-picker form-control col-md-12 col-xs-12" type="text">
            </div>
        </div>
