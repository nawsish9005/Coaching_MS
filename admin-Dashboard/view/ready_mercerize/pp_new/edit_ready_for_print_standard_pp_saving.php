<?php 
  ...
  $update_sql_statement = "UPDATE `ready_for_print_standard` 
   ...
   { 
       ...
       $sql = 'SELECT id
                FROM ready_for_print_standard ORDER BY id DESC LIMIT 1';
       $sql_res = mysqli_query($con, $sql) or die(mysqli_error($con));
       $sql_row = mysqli_fetch_assoc($sql_res);
       $ready_for_print_standard_id = $sql_row['id'] + 1;

    	$insert_sql_statement = "INSERT INTO `ready_for_print_standard` 
                                 ( 
