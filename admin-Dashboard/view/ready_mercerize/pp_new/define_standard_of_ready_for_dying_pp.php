        ...
        <form id="ready_for_dying_standard_form" name="ready_for_dying_standard_form" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              ...
              <button type="button" name="submit" id="submit" class="btn btn-success" onclick="send_data_of_define_standard_of_ready_for_dying_form_to_database('<?php echo $pp_no_id; ?>');">Submit</button>
