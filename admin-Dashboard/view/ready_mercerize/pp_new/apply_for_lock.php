<?php 
  ...
  else if ($select_pp_version_standard == 9)
  {
      $update_sql_statement = "UPDATE `finishing_standard` 
                    SET 
                      `lock_or_unlock` = '1',
                      `modifying_person_id`= '$edfms_logged_user_id',
                      `modification_time`= NOW()
  ...
  else if ($select_pp_version_standard == 10)
  {
  ...
  else if ($select_pp_version_standard == 11)
  {
      $update_sql_statement = "UPDATE `scouring_standard` 
                    SET 
                      `lock_or_unlock` = '1',
                      `modifying_person_id`= '$edfms_logged_user_id',
                      `modification_time`= NOW()
  ...
  else if ($select_pp_version_standard == 12)
  {
      $update_sql_statement = "UPDATE `washing_standard` 
                    SET 
                      `lock_or_unlock` = '1',
                      `modifying_person_id`= '$edfms_logged_user_id',
                      `modification_time`= NOW()
  ...
  else if ($select_pp_version_standard == 13)
  {
  ...
  else if ($select_pp_version_standard == 14)
  {
      $update_sql_statement = "UPDATE `sanforizing_standard` 
                    SET 
                      `lock_or_unlock` = '1',
                      `modifying_person_id`= '$edfms_logged_user_id',
                      `modification_time`= NOW()
  ...
  else if ($select_pp_version_standard == 15)
  {
      $update_sql_statement = "UPDATE `raising_standard` 
                    SET 
                      `lock_or_unlock` = '1',
                      `modifying_person_id`= '$edfms_logged_user_id',
                      `modification_time`= NOW()
  ...
  else if ($select_pp_version_standard == 16)
  {
  ...
  else if ($select_pp_version_standard == 17)
  {
      $update_sql_statement = "UPDATE `ready_for_print_standard` 
                    SET 
                      `lock_or_unlock` = '1',
                      `modifying_person_id`= '$edfms_logged_user_id',
                      `modification_time`= NOW()
  ...
  else if ($select_pp_version_standard == 18)
  {
      $update_sql_statement = "UPDATE `ready_for_dying_standard` 
                    SET 
                      `lock_or_unlock` = '1',
                      `modifying_person_id`= '$edfms_logged_user_id',
                      `modification_time`= NOW()
