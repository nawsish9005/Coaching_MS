                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select id="pp_no_id" name="pp_no_id" class="version_pp_no_id action_desc select2 pp_number form-control col-md-12 col-xs-12" onchange="add_desc()">
                                ...
                                <?php
                                  $pp_sql = "SELECT pp_no, pp_id, pp_desc FROM pp ORDER BY pp_id DESC";
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php 
                                ...
                                $sql_for_pp = "SELECT * FROM pp_details where active = '1' ORDER BY pp_id DESC";
                              ...
                              <tr>
                                ...
                                <td>
                                	<?php 
                                		...
                                		$sql_for_pp_details = "SELECT pp_no FROM pp WHERE pp_id = '$pp_no_id'";
                                ...
                                <td>
                                  <form action="edit_pp_version.php" method="post" style="display: inline-block;">
