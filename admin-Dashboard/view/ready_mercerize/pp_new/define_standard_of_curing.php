...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12" id="retrieve_edit_data" style="padding-bottom: 20px;">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Standard for Curing Process Form</h2>
        ...
        <form id="curing_standard_form" name="curing_standard_form" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="time_cond1" name="time_cond1" onchange="time_condition()" class="cf_rubbing_wet_cond1 form-control col-md-12 col-xs-12">
                <option value="2" selected="selected" <?php echo ($_POST['time_cond1'] == '2') ? 'selected' : '' ?> >[</option>
                <option value="1" <?php echo ($_POST['time_cond1'] == '1') ? 'selected' : '' ?> >(</option>
              </select>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="time_value1" name="time_value1" value="<?php echo isset($_POST['time_value1']) ? $_POST['time_value1'] : "" ?>" class="time_value1 form-control col-md-7 col-xs-12">
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2" style='text-align: center;'>
              --
            </div> 
            <div class="col-md-1 col-sm-1 col-xs-2">
              <input type="text" id="time_value2" name="time_value2" value="<?php echo isset($_POST['time_value2']) ? $_POST['time_value2'] : "" ?>" class="time_value2 form-control col-md-7 col-xs-12">
            </div>
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="time_cond2" name="time_cond2" class="time_cond2 form-control col-md-12 col-xs-12">
                <option value="2" selected="selected" <?php echo ($_POST['time_cond2'] == '2') ? 'selected' : '' ?> >]</option>
                <option value="1" <?php echo ($_POST['time_cond2'] == '1') ? 'selected' : '' ?> >)</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="temp_cond1" name="temp_cond1" onchange="temp_condition()" class="cf_rubbing_wet_cond1 form-control col-md-12 col-xs-12">
                <option value="2" selected="selected" <?php echo ($_POST['temp_cond1'] == '2') ? 'selected' : '' ?> >[</option>
            ...
            <div class="col-md-1 col-sm-1 col-xs-2">
              <select id="temp_cond2" name="temp_cond2" class="temp_cond2 form-control col-md-12 col-xs-12">
                <option value="2" selected="selected" <?php echo ($_POST['temp_cond2'] == '2') ? 'selected' : '' ?> >]</option>
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              ...
              <button type="button" name="submit" id="submit" class="btn btn-success" onclick="send_data_of_define_standard_of_curing_form_to_database('<?php echo $pp_version; ?>');">Submit</button>
