                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php 
                                    if ($res_model_gray_variable['rubbing_dry_cond1'] == 1) 
                                    {
                                      echo "( ";
                                    }
                                    elseif ($res_model_gray_variable['rubbing_dry_cond1'] == 2) 
                                    {
                                      echo "[ ";
                                    }
                                    else
                                    ...
                                    echo $res_model_gray_variable['rubbing_dry_value1'];
                                    echo " - ";
                                    echo $res_model_gray_variable['rubbing_dry_value2'];

                                    if ($res_model_gray_variable['rubbing_dry_cond2'] == 1) 
                                    {
                                      echo " )";
                                    }
                                    elseif ($res_model_gray_variable['rubbing_dry_cond2'] == 2) 
                                    {
                                      echo " ]";
                                    }
                                    else
                                ...
                                <td>
                                  <?php 
                                    if ($res_model_gray_variable['rubbing_wet_cond1'] == 1) 
                                    {
                                      echo "( ";
                                    }
                                    elseif ($res_model_gray_variable['rubbing_wet_cond1'] == 2) 
                                    {
                                      echo "[ ";
                                    }
                                    else
                                    ...
                                    echo $res_model_gray_variable['rubbing_wet_value1'];
                                    echo " - ";
                                    echo $res_model_gray_variable['rubbing_wet_value2'];

                                    if ($res_model_gray_variable['rubbing_wet_cond2'] == 1) 
                                    {
                                      echo " )";
                                    }
                                    elseif ($res_model_gray_variable['rubbing_wet_cond2'] == 2) 
                                    {
                                      echo " ]";
                                    }
                                    else
                                ...
                                <td>
                                  ...
                                  <?php 
                                      if (isset($row_model_gray_variable['rubbing_dry_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            <!-- data store for copy and next step -->
                          ...
                          <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                    <?php 
                                      if ($row_model_gray_variable['rubbing_dry_cond1'] == 1) 
                                      {
                                        echo "( ";
                                      }
                                      elseif ($row_model_gray_variable['rubbing_dry_cond1'] == 2) 
                                      {
                                        echo "[ ";
                                      }
                                      else
                                      ...
                                      echo $row_model_gray_variable['rubbing_dry_value1'];
                                      echo " - ";
                                      echo $row_model_gray_variable['rubbing_dry_value2'];

                                      if ($row_model_gray_variable['rubbing_dry_cond2'] == 1) 
                                      {
                                        echo " )";
                                      }
                                      elseif ($row_model_gray_variable['rubbing_dry_cond2'] == 2) 
                                      {
                                        echo " ]";
                                      }
                                      else
                                  ...
                                  <td>
                                    <?php 
                                      if ($row_model_gray_variable['rubbing_wet_cond1'] == 1) 
                                      {
                                        echo "( ";
                                      }
                                      elseif ($row_model_gray_variable['rubbing_wet_cond1'] == 2) 
                                      {
                                        echo "[ ";
                                      }
                                      else
                                      ...
                                      echo $row_model_gray_variable['rubbing_wet_value1'];
                                      echo " - ";
                                      echo $row_model_gray_variable['rubbing_wet_value2'];

                                      if ($row_model_gray_variable['rubbing_wet_cond2'] == 1) 
                                      {
                                        echo " )";
                                      }
                                      elseif ($row_model_gray_variable['rubbing_wet_cond2'] == 2) 
                                      {
                                        echo " ]";
                                      }
                                      else
                                ...
                                <td>
                                  ...
                                  <?php 
                                      if (isset($row_model_gray_variable['rubbing_wet_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            <!-- data store for copy and next step -->
                                      ...
                                      if (isset($row_model_gray_variable['cf_rubbing_dry_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['finishing_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                                      ...
                                      if (isset($row_model_gray_variable['absorbency_cond1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['scouring_bleaching_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                                      ...
                                      if (isset($row_model_gray_variable['absorbency_cond1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['scouring_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                                      ...
                                      if (isset($row_model_gray_variable['cf_rubbing_dry_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['washing_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                                      ...
                                      if (isset($row_model_gray_variable['cf_rubbing_dry_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['calendering_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                                      ...
                                      if (isset($row_model_gray_variable['cf_rubbing_dry_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['sanforizing_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <?php 
                                      if (isset($row_model_gray_variable['tensile_weft_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            <!-- data store for copy and next step -->
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['raising_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                                      ...
                                      if (isset($row_model_gray_variable['tensile_weft_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['ready_for_raising_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                                      ...
                                      if (isset($row_model_gray_variable['ph_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['ready_for_print_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
                                      ...
                                      if (isset($row_model_gray_variable['ph_value1'])) 
                                      {
                                        ?>
                                          <form id="copy_pp_version_details" name="copy_pp_version_details" style="display: inline-block;">
                                            ...
                                            <input type="hidden" id="pp_version_for_this" name="pp_version_for_this" value="<?php echo $pp_version_for_this; ?>">
                                            <input type="hidden" id="pp_version_standard" name="pp_version_standard" value="<?php echo $pp_version_standard; ?>">
                                            <button type="button" class="btn btn-xs btn-success text-center" onclick="copy_greige_issunce('<?php echo $row_model_gray_variable['ready_for_dying_standard_id']; ?>');">Copy</button>
                                          </form>
                                        <?php
                                      }
