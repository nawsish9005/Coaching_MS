...
$ready_mercerize_id = $_POST['ready_mercerize_id'];
                      ...
                      <div class="x_content">
                        ...
                        <?php
                          $sql_for_bleaching = "SELECT *
                                         ...
                                         AND ready_mercerize_id = '$ready_mercerize_id'
                                        ";
     ...
     $(document).ready(function(){
      ...
      $('#submit').click(function()
      {
          ...
          else
          {
              ...
              formdata.append("ready_mercerize_id", <?php echo $ready_mercerize_id; ?> );
              $.ajax({
              type: "POST",
              url: "edit_ready_mercerize_saving.php",// where you wanna post
              data: formdata,
              processData: false,
              contentType: false,
              ...
              success: function(data)
              {
                  ...
                  else
                  {
                      ...
                      success_alert("Data Save Successfully", "view_ready_mercerize.php?greige_issunce_id="+greige_issunce_id+"&route_issue_id="+route_issue_id);
                  }
              }
            });
          }
