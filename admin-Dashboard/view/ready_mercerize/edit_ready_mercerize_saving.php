<?php 
	...
	$ready_mercerize_id = mysqli_real_escape_string($con, stripslashes(trim($_POST['ready_mercerize_id'])));
	...
	$insert_pp_details_statement = "UPDATE `ready_mercerize` 
								    SET `date`= '$date',
								   		`b_batcher`= '$b_batcher',
								   		`a_batcher`= '$a_batcher',
								   		`p_width`= '$p_width',
								  ...
								  WHERE `route_issue_id` = '$route_issue_id' AND `route_issue_id` = '$route_issue_id'";
