...
if ($route_issue_id == "" || is_null($route_issue_id) || empty($route_issue_id) || 
    $ready_mercerize_id == "" || is_null($ready_mercerize_id) || empty($ready_mercerize_id)) 
{
    echo "No data found";
}
...
else
{
	?>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Ready Mercerize Form View</h2>
                      ...
                      <div class="x_content">
                        ...
                        <form action="edit_ready_mercerize.php" method="post" style="display: inline; padding-left: 200px;">
                          <input type="hidden" id="route_issue_id" name="route_issue_id" value="<?php echo $route_issue_id; ?>">
                          <input type="hidden" id="ready_mercerize_id" name="ready_mercerize_id" value="<?php echo $ready_mercerize_id; ?>">
