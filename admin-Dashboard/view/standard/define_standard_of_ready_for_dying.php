...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12" id="retrieve_edit_data" style="padding-bottom: 20px;">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Standard for Ready for Dying Process Form</h2>
        ...
        <form id="ready_for_dying_standard_form" name="ready_for_dying_standard_form" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              ...
              <button type="button" name="submit" id="submit" class="btn btn-success" onclick="send_data_of_define_standard_of_ready_for_dying_form_to_database('<?php echo $pp_version; ?>');">Submit</button>
