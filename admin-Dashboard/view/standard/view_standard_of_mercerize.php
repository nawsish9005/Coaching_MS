          ...
          <tbody>
            <?php 
              ...
              $sql_for_pp = "SELECT 
                             ...
                             FROM 
                                pp, pp_details, mercerize_standard   
                             WHERE 
                                pp.pp_id = '$pp_no_id'
                                AND pp.pp_id = pp_details.pp_no_id
                                AND pp_details.pp_id = '$pp_version'
                                AND mercerize_standard.pp_no_id = pp_details.pp_no_id
                                AND mercerize_standard.pp_details_id = pp_details.pp_id
                                AND mercerize_standard.active = '1'
