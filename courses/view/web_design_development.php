                  ...
                  <div class="bt_bb_wrapper">
                                          ...
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                                ...
                                                <header class="bt_bb_headline bt_bb_color_scheme_5 bt_bb_dash_top_bottom bt_bb_size_extralarge bt_bb_superheadline bt_bb_align_inherit bt_bb_dash_color_scheme_4">
                                                   <h1><span class="bt_bb_headline_superheadline">ALL COURSES</span><span class="bt_bb_headline_content"><span>Web Design & Development</span></span></h1>
                                                </header>
                                                ...
                                                <div class="bt_bb_button bt_bb_icon_position_left bt_bb_color_scheme_6 bt_bb_style_filled bt_bb_size_small bt_bb_width_inline bt_bb_shape_inherit bt_bb_align_inherit">
                                                    <a href="../../registration" target="_self" class="bt_bb_link" title="APPLY TODAY"><span class="bt_bb_button_text">APPLY TODAY</span></a></div>
                     ...
                     <section id="bt_bb_section5fe4d376edc40"  class="bt_bb_section bt_bb_bottom_spacing_large bt_bb_layout_boxed_1200 bt_bb_vertical_align_top" >
                        <div class="bt_bb_port">
                       	...
                       	<?php 
							$sql = (mysqli_query($con,"SELECT * FROM all_web ORDER BY web_id DESC "));
                                                ...
                                                <div class="bt_bb_event bt_bb_shape_square">
                                                   <div class="bt_bb_event">
                                                 	...
                                                 	<div class="bt_bb_image">
                                                 		<span>
                                             <img style="height:379px; width:563px;" src="../../admin/build/user_pic/<?php echo $row['web_image']; ?>">
                                                 		</span>
                                                 	</div>
                                                      </div>
                                                      <div class="bt_bb_event_content">
                                                         <h3 class="bt_bb_event_content_title"><?php echo $row['subject_web']; ?></h3>
                                                         ...
                                                         <div class="bt_bb_event_content_inner">
                                                            <div class="bt_bb_button bt_bb_icon_position_right bt_bb_color_scheme_3 bt_bb_style_clean bt_bb_size_small bt_bb_width_inline bt_bb_shape_inherit bt_bb_align_inherit">
                                                                <a href="../web_design_development?course:=<?php echo $row['subject_web'];?>" target="_self" class="bt_bb_link" title="APPLY NOW"><span class="bt_bb_button_text">View More</span><span  data-ico-dripicons="&#xe90c;" class="bt_bb_icon_holder"></span></a></div>
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
