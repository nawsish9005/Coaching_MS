...
<html class="no-js" lang="en-US" data-bt-theme="Tabula 1.0.3">
   ...
   <head>
      ...
      <?php 
         $sql = (mysqli_query($con,"SELECT * FROM all_digital WHERE subject_digital = 'subject_digital' "));
         		while($row = mysqli_fetch_assoc($sql)){
         	
         	$subject_digital = $row['subject_digital'];
         				   			
         ?>
      <title><?php echo $row['subject_digital']; ?></title>
      <?php } ?>
               ...
               <div class="btContent">
				  ...
				  <?php 
						...
						while($row = mysqli_fetch_assoc($sql)){
						     ...
						     $subject_digital = $row['subject_digital'];
							$about_digital = $row['about_digital'];
							$price_digital = $row['price_digital'];
							$image_digital = $row['image_digital'];
							$duration_digital = $row['duration_digital'];
							$effort_digital = $row['effort_digital'];
							$certificate_digital = $row['certificate_digital'];
							$total_class_digital = $row['total_class_digital'];
						
					?>
                     <section id="bt_bb_section5fe4d4f9dc409" data-parallax="0.7" data-parallax-offset="0" data-background_image_src="'../admin/build/user_pic/<?php echo $row['image_digital']; ?>'" class="bt_bb_section bt_bb_top_spacing_large bt_bb_bottom_spacing_large bt_bb_color_scheme_1 bt_bb_layout_boxed_1200 bt_bb_vertical_align_top bt_bb_parallax btLazyLoadBackground bt_bb_background_image bt_bb_background_overlay_dark_solid" style="background-image:url(http_/tabula.bold-themes.com/sunny/wp-content/plugins/bold-page-builder/img/blank.html);">
                                          ...
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                                ...
                                                <header class="bt_bb_headline bt_bb_color_scheme_6 bt_bb_dash_none bt_bb_size_extralarge bt_bb_superheadline bt_bb_subheadline bt_bb_align_inherit">
                                                   <h1><span class="bt_bb_headline_superheadline">View Digital Marketing Course</span><span class="bt_bb_headline_content"><span> Mowgli IT School | Digital Marketing</span></span></h1>
                              ...
                              <div class="bt_bb_cell_inner">
                                 <div class="bt_bb_row_wrapper">
                                    <div  class="bt_bb_row bt_bb_column_gap_0 bt_bb_shape_inherit" >
                                          ...
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                                <header class="bt_bb_headline bt_bb_color_scheme_5 bt_bb_dash_top_bottom bt_bb_size_large bt_bb_superheadline bt_bb_align_inherit bt_bb_dash_color_scheme_15">
                                                   <h3><!--span class="bt_bb_headline_superheadline">FRENCH STREET</span!--><span class="bt_bb_headline_content"><span><?php echo $row['subject_digital']; ?></span></span></h3>
                                                </header>
									   ...
									   <div>Course Fee: <?php echo $row['price_digital']; ?></div>
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                 ...
                                 <div class="bt_bb_row_wrapper">
                                    <div  class="bt_bb_row bt_bb_column_gap_30 bt_bb_shape_inherit" >
									   ...
									   <div class="bt_bb_image"><span><img style="height:700px; width:800px;" src="../admin/build/user_pic/<?php echo $row['image_digital']; ?>" title="courses_01" alt="admin/biuld/user_pic/<?php echo $row['image_digital']; ?>"></span></div>
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                                <div  class="bt_bb_text" >
                                                   <p><?php echo $row['about_digital']; ?>.</p>
                                                </div>
                                                <div class="bt_bb_separator bt_bb_bottom_spacing_medium bt_bb_border_style_none"></div>
                                             </div>
                                          </div>
                                                ...
                                                <div class="bt_bb_accordion bt_bb_color_scheme_3 bt_bb_style_simple bt_bb_shape_square" data-closed=closed>
                                                   <div class="bt_bb_accordion_item btWithIcon">
                                                      ...
                                                      <div class="bt_bb_accordion_item_content">
                                                         <div  class="bt_bb_text" >
                                                            <p><?php echo $row['effort_digital']; ?></p>
                                                         </div>
                                                      </div>
                                                   </div>
												   <div class="bt_bb_accordion_item btWithIcon">
                                                      ...
                                                      <div class="bt_bb_accordion_item_content">
                                                         <div  class="bt_bb_text" >
                                                            <p><?php echo $row['duration_digital']; ?></p>
                                                         </div>
                                                      </div>
                                                   </div>
												   <div class="bt_bb_accordion_item btWithIcon">
                                                      ...
                                                      <div class="bt_bb_accordion_item_content">
                                                         <div  class="bt_bb_text" >
                                                            <p><?php echo $row['total_class_digital']; ?></p>
                                                         </div>
                                                      </div>
                                                   </div>
                                                   <div class="bt_bb_accordion_item btWithIcon">
                                                      ...
                                                      <div class="bt_bb_accordion_item_content">
                                                         <div  class="bt_bb_text" >
                                                            <p><?php echo $row['certificate_digital']; ?></p>
                                                         </div>
                                                      </div>
                                                   </div>
