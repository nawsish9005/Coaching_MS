...
<html class="no-js" lang="en-US" data-bt-theme="Tabula 1.0.3">
   ...
   <head>
      ...
      <?php 
         $sql = (mysqli_query($con,"SELECT * FROM m_courses WHERE subject_graphics = '$subject_graphics' "));
         		while($row = mysqli_fetch_assoc($sql)){
         	
         	$subject_graphics = $row['subject_graphics'];
         				   			
         ?>
      <title><?php echo $row['subject_graphics']; ?></title>
      <?php } ?>
            ...
            <div class="btContentHolder">
               <div class="btContent">
				  ...
				  <?php 
						...
						$sql = (mysqli_query($con,"SELECT * FROM all_graphics WHERE subject_graphics='$subject_graphics' "));
						while($row = mysqli_fetch_assoc($sql)){
                                          ...
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                                ...
                                                <header class="bt_bb_headline bt_bb_color_scheme_6 bt_bb_dash_none bt_bb_size_extralarge bt_bb_superheadline bt_bb_subheadline bt_bb_align_inherit">
                                                   <h1><span class="bt_bb_headline_superheadline">View Details of Graphic Design</span><span class="bt_bb_headline_content"><span> Mowgli IT School | Graphics Design</span></span></h1>
                              ...
                              <div class="bt_bb_cell_inner">
                                 <div class="bt_bb_row_wrapper">
                                    <div  class="bt_bb_row bt_bb_column_gap_0 bt_bb_shape_inherit" >
                                          ...
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                                <header class="bt_bb_headline bt_bb_color_scheme_5 bt_bb_dash_top_bottom bt_bb_size_large bt_bb_superheadline bt_bb_align_inherit bt_bb_dash_color_scheme_15">
                                                   <h3><!--span class="bt_bb_headline_superheadline">FRENCH STREET</span!--><span class="bt_bb_headline_content"><span><?php echo $row['subject_graphics']; ?></span></span></h3>
                                                </header>
									   ...
									   <div>Course Fee: <?php echo $row['price_graphics']; ?></div>
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                                <div class="bt_bb_button bt_bb_icon_position_left bt_bb_color_scheme_6 bt_bb_style_filled bt_bb_size_medium bt_bb_width_inline bt_bb_shape_inherit bt_bb_align_inherit">
                                                    <a href="../registration" target="_self" class="bt_bb_link" title="APPLY NOW"><span class="bt_bb_button_text">APPLY NOW</span></a></div>
                                 ...
                                 <div class="bt_bb_row_wrapper">
                                    <div  class="bt_bb_row bt_bb_column_gap_30 bt_bb_shape_inherit" >
									   ...
									   <div class="bt_bb_image"><span><img style="height:400px; width:800px;" src="../admin/build/user_pic/<?php echo $row['image_graphics']; ?>" title="courses_01" alt="admin/biuld/user_pic/<?php echo $row['courses_image']; ?>"></span></div>
                                          <div class="bt_bb_column_content">
                                             <div class="bt_bb_column_content_inner">
                                                <div  class="bt_bb_text" >
                                                   <p><?php echo $row['about_graphics']; ?>.</p>
                                                </div>
                                                <div class="bt_bb_separator bt_bb_bottom_spacing_medium bt_bb_border_style_none"></div>
                                             </div>
                                          </div>
                                                ...
                                                <div class="bt_bb_accordion bt_bb_color_scheme_3 bt_bb_style_simple bt_bb_shape_square" data-closed=closed>
                                                   <div class="bt_bb_accordion_item btWithIcon">
                                                      <div class="bt_bb_accordion_item_title_content">
                                                         ...
                                                         <div class="bt_bb_accordion_item_title">Course Effort</div>
                                                      </div>
                                                      <div class="bt_bb_accordion_item_content">
                                                         <div  class="bt_bb_text" >
                                                            <p><?php echo $row['effort_graphics']; ?></p>
                                                         </div>
                                                      </div>
                                                   </div>
												   <div class="bt_bb_accordion_item btWithIcon">
                                                      ...
                                                      <div class="bt_bb_accordion_item_content">
                                                         <div  class="bt_bb_text" >
                                                            <p><?php echo $row['duration_graphics']; ?></p>
                                                         </div>
                                                      </div>
                                                   </div>
												   <div class="bt_bb_accordion_item btWithIcon">
                                                      ...
                                                      <div class="bt_bb_accordion_item_content">
                                                         <div  class="bt_bb_text" >
                                                            <p><?php echo $row['total_class_graphics']; ?></p>
                                                         </div>
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="bt_bb_accordion_item btWithIcon">
                                                      ...
                                                      <div class="bt_bb_accordion_item_content">
                                                         <div  class="bt_bb_text" >
                                                            <p><?php echo $row['certificate_graphics']; ?></p>
                                                         </div>
                                                      </div>
                                                   </div>
